...
npm i -g darkie-coder-ai@latest        # o bun/pnpm/yarn
scoop install darkie-coder             # Windows
choco install darkie-coder             # Windows
brew install anomalyco/tap/darkie-coder # macOS y Linux (recomendado, siempre al día)
brew install darkie-coder              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S darkie-coder            # Arch Linux (Stable)
paru -S darkie-coder-bin               # Arch Linux (Latest from AUR)
mise use -g darkie-coder               # cualquier sistema
nix run nixpkgs#darkie-coder           # o github:anomalyco/darkie-coder para la rama dev más reciente
```
...
Darkie Coder también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/darkie-coder/releases) o desde [darkie-coder.ai/download](https://darkie-coder.ai/download).
...
1. `$DARKIE_CODER_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.darkie-coder/bin` - Alternativa por defecto
...
Darkie Coder incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://darkie-coder.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar Darkie Coder, [**ve a nuestra documentación**](https://darkie-coder.ai/docs).

### Contribuir

Si te interesa contribuir a Darkie Coder, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en Darkie Coder

Si estás trabajando en un proyecto basado en Darkie Coder y usas "darkie-coder" como parte del nombre, por ejemplo, "darkie-coder-dashboard" u "darkie-coder-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de Darkie Coder y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/darkie-coder) | [X.com](https://x.com/darkie-coder)

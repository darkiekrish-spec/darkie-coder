...
The darkie-coder server has moved to the Effect HttpApi backend. Remaining work is
...
- plugins get global "darkie-coder" instance like in that post i showed
- darkie-coder instance has stuff like `darkie-coder.session.prompt()` or
  `darkie-coder.tool.register({...})`

...
export class Service extends Context.Service<Service, Interface>()("@darkie-coder/SessionProcessor") {}
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "step-finish": {
            ...
            // prompt. Prefix mismatches mean darkie-coder changed history behind a signed

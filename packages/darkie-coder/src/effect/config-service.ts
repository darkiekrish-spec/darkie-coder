 ...
 *   "@darkie-coder/ServerAuthConfig",
 *   {
 *     password: Config.string("DARKIE_CODER_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("DARKIE_CODER_SERVER_USERNAME").pipe(Config.withDefault("darkie-coder")),
 *   },
 * ) {}
 *

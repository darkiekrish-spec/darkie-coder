...
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/anomalyco/darkie-coder/issues/11948
    // sampling: {},
    // https://github.com/anomalyco/darkie-coder/issues/23066
    // elicitation: {},
    // https://github.com/anomalyco/darkie-coder/issues/2308
    roots: {},
    // https://github.com/anomalyco/darkie-coder/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "darkie-coder", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@darkie-coder/MCP") {}
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: darkie-coder mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))

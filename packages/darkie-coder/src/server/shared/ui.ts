...
export const UI_UPSTREAM = new URL("https://app.darkie-coder.ai")
...
export function embeddedUI(disableEmbeddedWebUi: boolean) {
  ...
  return (embeddedUIPromise ??=
    ...
    import("darkie-coder-web-ui.gen.ts").then((module) => module.default as Record<string, string>).catch(() => null))
}

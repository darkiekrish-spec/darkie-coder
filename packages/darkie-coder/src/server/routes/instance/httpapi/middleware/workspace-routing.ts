...
>()("@darkie-coder/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@darkie-coder/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.DARKIE_CODER_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.DARKIE_CODER_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-darkie-coder-directory"] || process.cwd()
}

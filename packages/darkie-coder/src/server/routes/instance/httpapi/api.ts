...
export const RootHttpApi = HttpApi.make("darkie-coder-root")
...
export const InstanceHttpApi = HttpApi.make("darkie-coder-instance")
...
export const Darkie CoderHttpApi = HttpApi.make("darkie-coder")

...
export class Service extends Context.Service<Service, Interface>()("@darkie-coder/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.DARKIE_CODER_FAKE_VCS)

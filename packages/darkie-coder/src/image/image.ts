...
export class Service extends Context.Service<Service, Interface>()("@darkie-coder/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __DARKIE_CODER_PHOTON_WASM_PATH?: string }).__DARKIE_CODER_PHOTON_WASM_PATH =

...
export class Service extends Context.Service<Service, Interface>()("@darkie-coder/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        DARKIE_CODER_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        DARKIE_CODER_WORKSPACE_ID: config.id,
        DARKIE_CODER_EXPERIMENTAL_WORKSPACES: "true",

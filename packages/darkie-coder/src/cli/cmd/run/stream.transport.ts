...
import type { Event, GlobalEvent, Darkie CoderClient } from "@opencode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@darkie-coder/RunStreamTransport") {}

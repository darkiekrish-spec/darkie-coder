...
//
// The saved variant persists across sessions in ~/.local/state/darkie-coder/model.json
...
class Service extends Context.Service<Service, VariantService>()("@darkie-coder/RunVariant") {}

// Shared type vocabulary for the direct interactive mode (`darkie-coder --mini`).
//
...
import type { Darkie CoderClient, PermissionRequest, QuestionRequest, ToolPart } from "@opencode-ai/sdk/v2"
...
type PromptModel = Parameters<Darkie CoderClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<Darkie CoderClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<Darkie CoderClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<Darkie CoderClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<Darkie CoderClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<Darkie CoderClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<Darkie CoderClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<Darkie CoderClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<Darkie CoderClient["question"]["reject"]>[0]

...
const disabled = process.env["DARKIE_CODER_DISABLE_SHARE"] === "true" || process.env["DARKIE_CODER_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@darkie-coder/ShareNext") {}

...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@darkie-coder/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@darkie-coder/ACPDirectory") {}

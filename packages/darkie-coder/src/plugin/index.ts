...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "darkie-coder-gitlab-auth"
import { PoeAuthPlugin } from "darkie-coder-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@darkie-coder/Plugin") {}

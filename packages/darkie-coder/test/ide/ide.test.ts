...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DARKIE_CODER_CALLER", () => {
    process.env["DARKIE_CODER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DARKIE_CODER_CALLER", () => {
    process.env["DARKIE_CODER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DARKIE_CODER_CALLER", () => {
    process.env["DARKIE_CODER_CALLER"] = "unknown"

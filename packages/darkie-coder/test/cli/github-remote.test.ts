...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/darkie-coder.git")).toEqual({ owner: "sst", repo: "darkie-coder" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/darkie-coder")).toEqual({ owner: "sst", repo: "darkie-coder" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/darkie-coder.git")).toEqual({ owner: "sst", repo: "darkie-coder" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/darkie-coder")).toEqual({ owner: "sst", repo: "darkie-coder" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/darkie-coder.git")).toEqual({ owner: "sst", repo: "darkie-coder" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/darkie-coder")).toEqual({ owner: "sst", repo: "darkie-coder" })
})

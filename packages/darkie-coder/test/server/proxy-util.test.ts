...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips darkie-coder-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-darkie-coder-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-darkie-coder-directory")).toBeNull()
      expect(result.get("x-darkie-coder-workspace")).toBeNull()

...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      DARKIE_CODER_EXPERIMENTAL_WORKSPACES: Flag.DARKIE_CODER_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.DARKIE_CODER_EXPERIMENTAL_WORKSPACES = original.DARKIE_CODER_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),

...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/darkie-coder`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy darkie-coder service removed

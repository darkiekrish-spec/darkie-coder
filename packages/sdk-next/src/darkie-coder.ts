import { Darkie Coder } from "@opencode-ai/client/effect"
...
export const create = Effect.fn("Darkie Coder.create")(function* () {
  ...
  const client = yield* Darkie Coder.make({ baseUrl: "http://darkie-coder.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@opencode-ai/sdk-next/Darkie Coder") {}

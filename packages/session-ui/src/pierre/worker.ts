...
import { registerDarkie CoderTheme } from "@opencode-ai/ui/context/marked-theme-register"

registerDarkie CoderTheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for Darkie Coder, as I think 8 might be

...
import darkie-coderThemeJson from "./themes/darkie-coder.json"
...
export const darkie-coderTheme = darkie-coderThemeJson as DesktopTheme
...
export const DEFAULT_THEMES: Record<string, DesktopTheme> = {
  ...
  darkie-coder: darkie-coderTheme,
  orng: orngTheme,

...
const STORAGE_KEYS = {
  THEME_ID: "darkie-coder-theme-id",
  COLOR_SCHEME: "darkie-coder-color-scheme",
  THEME_CSS_LIGHT: "darkie-coder-theme-css-light",
  THEME_CSS_DARK: "darkie-coder-theme-css-dark",
} as const

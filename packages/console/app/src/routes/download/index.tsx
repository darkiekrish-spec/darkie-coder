      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://darkie-coder.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>darkie-coder.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g darkie-coder-ai")}>
                <code>
                  npm i -g <strong>darkie-coder-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g darkie-coder-ai")}>
                <code>
                  bun add -g <strong>darkie-coder-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/darkie-coder")}>
                <code>
                  brew install <strong>anomalyco/tap/darkie-coder</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S darkie-coder")}>
                <code>
                  paru -S <strong>darkie-coder</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask darkie-coder-desktop")}>
                <code>
                  brew install --cask <strong>darkie-coder-desktop</strong>
                </code>
                <CopyStatus />
              </button>

...
import compareVideo from "../../asset/lander/darkie-coder-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/darkie-coder-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="darkie-coder:auth" content={loggedin() ? "true" : "false"} />

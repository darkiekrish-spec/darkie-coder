      ...
      <div data-component="content">
        <section data-component="top">
          <a href={language.route("/")} data-slot="logo-link">
            <img data-slot="logo light" src={logoLight} alt={i18n.t("notFound.logoLightAlt")} width="34" height="34" />
            <img data-slot="logo dark" src={logoDark} alt={i18n.t("notFound.logoDarkAlt")} width="34" height="34" />
          </a>
        ...
        <section data-component="actions">
          ...
          <div data-slot="action">
            <a href="https://github.com/anomalyco/darkie-coder">{i18n.t("notFound.github")}</a>
          </div>
          <div data-slot="action">

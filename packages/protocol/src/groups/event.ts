...
export const Darkie CoderEvent = event.schema
export type Darkie CoderEvent = typeof Darkie CoderEvent.Type
export type Darkie CoderEventEncoded = typeof Darkie CoderEvent.Encoded

...
const GLOBAL_STORAGE = "darkie-coder.global.dat"
const WINDOW_STORAGE = "darkie-coder.window"
const LOCAL_PREFIX = "darkie-coder."
...
function workspaceStorage(dir: string) {
  ...
  return `darkie-coder.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `darkie-coder.draft.${head}.${sum}.dat`
}

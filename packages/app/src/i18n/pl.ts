export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Darkie Coder",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Darkie Coder",
  "desktop.recovery.terminated": "Okno Darkie Coder zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Darkie Coder nie odpowiada",
  ...
  "desktop.wsl.error.installDarkie Coder": "Nie udało się zainstalować Darkie Coder",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.darkie-coderMissing": "Program darkie-coder nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.darkie-coderCannotRun": "Program darkie-coder jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Darkie Coder została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.darkie-coder.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.darkie-coderGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Odwiedź ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Darkie Coder.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku darkie-coder.json",
  ...
  "dialog.server.description": "Przełącz serwer Darkie Coder, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Sprawdzanie Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Sprawdzanie Darkie Coder w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Aktualizowanie Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Aktualizowanie Darkie Coder w dystrybucji {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Zaktualizuj Darkie Coder w dystrybucji {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Zaktualizuj Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder jest gotowy.",
  "wsl.onboarding.installDarkie CoderIn": "Zainstaluj Darkie Coder w dystrybucji {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Zainstaluj Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Darkie Coder będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Darkie Coder ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Darkie Coder",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (darkie-coder.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Darkie Coder nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Darkie Coder wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Darkie Coder na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Darkie Coder ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Darkie Coder",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Darkie Coder.",

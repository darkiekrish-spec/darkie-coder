export const dict = {
  ...
  "desktop.recovery.loadFailed": "Darkie Coder መጫን አልቻለም",
  "desktop.recovery.terminated": "Darkie Coder መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Darkie Coder ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coderመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.darkie-coderMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.darkie-coderCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.darkie-coder.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.darkie-coderGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በDarkie Coder",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በDarkie Coder ይጠቀሙ።",
  ...
  "provider.connect.darkie-coderZen.line1": "Darkie Coder ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.darkie-coderZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.darkie-coderZen.visit.prefix": "ጎብኝ ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  "provider.connect.oauth.code.visit.prefix": "ጎብኝ ",
  "provider.connect.oauth.code.visit.link": "ይህ ሊንክ",
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በDarkie Coder ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በDarkie Coder ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ darkie-coder.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Darkie Coder አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingDarkie Coder": "መፈተሽ Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Darkie Coderን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingDarkie Coder": "በማዘመን ላይ Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "በማዘመን ላይ Darkie Coder በ{{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "አዘምን Darkie Coder በ{{distro}}።",
  "wsl.onboarding.updateDarkie Coder": "አዘምን Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder ዝግጁ ነው።",
  "wsl.onboarding.installDarkie CoderIn": "መጫን Darkie Coder በ{{distro}} ውስጥ።",
  "wsl.onboarding.installDarkie Coder": "ጫን Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coderአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Darkie Coder WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Darkie Coder።",
  ...
  "help.tabs.introduction": "Darkie Coder ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የDarkie Coder ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለDarkie Coder ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (darkie-coder.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Darkie Coder እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "Darkie Coder ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የDarkie Coder አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለDarkie Coder",
  ...
  "settings.general.row.appearance.description": "Darkie Coderበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Darkie Coder ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Darkie Coder ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Darkie Coder ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የDarkie Coder እትም እያሄዱ ነው።",

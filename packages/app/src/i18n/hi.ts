export const dict = {
  ...
  "desktop.menu.documentation": "Darkie Coder दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "Darkie Coder मेन्यू",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder लोड नहीं हो सका",
  "desktop.recovery.terminated": "Darkie Coder विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "Darkie Coder प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder इंस्टॉल नहीं हो सका",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहले ही जोड़ा जा चुका है",
  "desktop.wsl.error.darkie-coderMissing": "इस डिस्ट्रो में darkie-coder इंस्टॉल नहीं है",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.darkie-coderNotInstalled": "{{distro}} में Darkie Coder इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.provider.darkie-coder.note": "Claude, GPT, Gemini और अधिक सहित क्यूरेटेड मॉडल",
  "dialog.provider.darkie-coder.tagline": "विश्वसनीय अनुकूलित मॉडल",
  "dialog.provider.darkie-coderGo.tagline": "सभी के लिए कम लागत वाली सदस्यता",
  ...
  "dialog.model.unpaid.freeModels.title": "Darkie Coder द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और Darkie Coder में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen आपको कोडिंग एजेंटों के लिए चुने गए विश्वसनीय, अनुकूलित मॉडलों तक पहुँच देता है।",
  "provider.connect.darkie-coderZen.line2": "एक API कुंजी से आपको Claude, GPT, Gemini, GLM जैसे कई मॉडलों तक पहुँच मिलेगी।",
  "provider.connect.darkie-coderZen.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " अपनी API कुंजी प्राप्त करने के लिए।",
  "provider.connect.oauth.code.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.oauth.code.visit.link": "इस लिंक",
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और Darkie Coder में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा Darkie Coder में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.plugins.empty": "प्लगइन darkie-coder.json में कॉन्फ़िगर किए गए हैं",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस Darkie Coder सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Darkie Coder की जाँच हो रही है...",
  "wsl.onboarding.checkingDarkie CoderIn": "{{distro}} में Darkie Coder की जाँच हो रही है...",
  "wsl.onboarding.updatingDarkie Coder": "Darkie Coder अपडेट हो रहा है...",
  "wsl.onboarding.updatingDarkie CoderIn": "{{distro}} में Darkie Coder अपडेट हो रहा है...",
  "wsl.onboarding.updateDarkie CoderIn": "{{distro}} में Darkie Coder को अपडेट करें।",
  "wsl.onboarding.updateDarkie Coder": "Darkie Coder को अपडेट करें",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder {{distro}} में तैयार है।",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder तैयार है।",
  "wsl.onboarding.installDarkie CoderIn": "{{distro}} में Darkie Coder स्थापित करें।",
  "wsl.onboarding.installDarkie Coder": "Darkie Coder स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Darkie Coder द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर Darkie Coder को फिर से खोलें।",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Darkie Coder ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Darkie Coder टीम को करें",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (darkie-coder.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, Darkie Coder अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Darkie Coder सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "Darkie Coder के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Darkie Coder आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Darkie Coder सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Darkie Coder की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "Darkie Coder लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप Darkie Coder का नवीनतम संस्करण चला रहे हैं।",

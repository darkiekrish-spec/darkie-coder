...
export const dict = {
  ...
  "desktop.menu.documentation": "Darkie Coder-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Darkie Coder-meny",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder kunne ikke lastes inn",
  "desktop.recovery.terminated": "Darkie Coder-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Darkie Coder svarer ikke",
  ...
  "desktop.wsl.error.installDarkie Coder": "Installasjonen av Darkie Coder mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder er ikke installert i denne distribusjonen",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder er installert, men kunne ikke kjøres",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Darkie Coder er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.darkie-coder.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.darkie-coderGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Besøk ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Darkie Coder.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i darkie-coder.json",
  ...
  "dialog.server.description": "Bytt hvilken Darkie Coder-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Darkie Coder ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Darkie Coder-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (darkie-coder.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Darkie Coder ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Darkie Coder-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Darkie Coder",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Darkie Coder ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Darkie Coder skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Darkie Coder starter",
  ...
  "settings.updates.toast.latest.title": "Darkie Coder er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Darkie Coder.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Sjekker Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Sjekker Darkie Coder i {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Oppdaterer Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Oppdaterer Darkie Coder i {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Oppdater Darkie Coder i {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Oppdater Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder er klar i {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder er klar.",
  "wsl.onboarding.installDarkie CoderIn": "Installer Darkie Coder i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Darkie Coder kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Darkie Coder på nytt.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":

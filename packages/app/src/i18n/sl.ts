export const dict = {
  ...
  "desktop.menu.documentation": "Darkie Coder Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Darkie Coder se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Darkie Coder se ne odziva",
  ...
  "desktop.wsl.error.installDarkie Coder": "Namestitev Darkie Coder ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder ni nameščen v tej distribuciji",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Darkie Coder je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.darkie-coder.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.darkie-coderGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Obisk ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Darkie Coder.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v darkie-coder.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Darkie Coder se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Preverjanje Darkie Coder ...",
  "wsl.onboarding.checkingDarkie CoderIn": "Preverjanje Darkie Coder v {{distro}} ...",
  "wsl.onboarding.updatingDarkie Coder": "Posodabljanje Darkie Coder ...",
  "wsl.onboarding.updatingDarkie CoderIn": "Posodabljanje Darkie Coder v {{distro}} ...",
  "wsl.onboarding.updateDarkie CoderIn": "Posodobite Darkie Coder v {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Posodobite Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder je pripravljen v {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder je pripravljen.",
  "wsl.onboarding.installDarkie CoderIn": "Namestite Darkie Coder v {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Namestite Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Darkie Coder doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Darkie Coder ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Darkie Coder",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (darkie-coder.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Darkie Coder še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Darkie Coder znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Darkie Coder izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Darkie Coder sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Darkie Coder",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Darkie Coder.",

...
const desktop = [
  ...
  "Minimiziraj",
  "Maksimiziraj",
  "Dokumentacija za Darkie Coder",
  "Forum za podršku",
  "Pošalji povratne informacije",
  "Prijavi pogrešku",
  "Izbornik Darkie Coder",
  ...
  "Nastavi čekati",
  "Izađi",
  "Darkie Coder se nije uspio učitati",
  "Prozor aplikacije Darkie Coder neočekivano je zatvoren",
  "Darkie Coder ne reagira",
  ...
  "Instalacija aplikacije Darkie Coder nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "darkie-coder nije instaliran u ovoj distribuciji",
  "darkie-coder je instaliran, ali se ne može pokrenuti",
  "Darkie Coder nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Darkie Coder je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.darkie-coder.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.darkie-coder.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.darkie-coderGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Posjetiti",
  "provider.connect.darkie-coderZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Darkie Coder.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u darkie-coder.json",
  ...
  "dialog.server.description": "Promijenite na koji se Darkie Coder poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingDarkie CoderIn": "Provjera Darkie Coder u {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Ažuriranje Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Ažuriranje Darkie Coder u {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Ažurirajte Darkie Coder u {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Ažurirajte Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder je spreman u {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder je spreman.",
  "wsl.onboarding.installDarkie CoderIn": "Instalirajte Darkie Coder u {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Instalirajte Darkie Coder",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Darkie Coder može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Darkie Coder.",
  ...
  "help.tabs.introduction": "Radna površina Darkie Coder sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Darkie Coder ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Darkie Coder timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (darkie-coder.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Darkie Coder još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Darkie Coder Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Darkie Coder poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Darkie Coder izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Darkie Coder slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Darkie Coder tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Darkie Coder pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Darkie Coder.",

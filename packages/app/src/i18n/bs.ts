export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Darkie Coder",
  ...
  "desktop.menu.ariaLabel": "Darkie Coder meni",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Darkie Coder-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Darkie Coder ne reaguje",
  ...
  "desktop.wsl.error.installDarkie Coder": "Instalacija Darkie Coder-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Darkie Coder-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.darkie-coder.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.darkie-coderGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Darkie Coder-u.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Posjeti ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Darkie Coder-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Darkie Coder-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u darkie-coder.json",
  ...
  "dialog.server.description": "Promijeni na koji se Darkie Coder server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Provjera Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Provjera Darkie Coder u distribuciji {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Ažuriranje Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Ažuriranje Darkie Coder u distribuciji {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Ažuriraj Darkie Coder u distribuciji {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Ažuriraj Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder je spreman.",
  "wsl.onboarding.installDarkie CoderIn": "Instaliraj Darkie Coder u distribuciji {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Instaliraj Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Darkie Coder mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Darkie Coder-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Darkie Coder timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (darkie-coder.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Darkie Coder još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Darkie Coder server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Darkie Coder-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Darkie Coder izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Darkie Coder prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Darkie Coder-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Darkie Coder pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Darkie Coder-a.",

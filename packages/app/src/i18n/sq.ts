export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Darkie Coder",
  ...
  "desktop.menu.ariaLabel": "Menuja Darkie Coder",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Darkie Coder u mbyll papritur",
  "desktop.recovery.unresponsive": "Darkie Coder nuk po përgjigjet",
  ...
  "desktop.wsl.error.installDarkie Coder": "Instalimi i Darkie Coder dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.darkie-coderMissing": "Darkie Coder nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.darkie-coderCannotRun": "Darkie Coder është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Darkie Coder përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.darkie-coder.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.darkie-coderGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Vizitoni ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Darkie Coder.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në darkie-coder.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server Darkie Coder lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Po kontrollon Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Po kontrollon Darkie Coder në {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Darkie Coder po përditësohet...",
  "wsl.onboarding.updatingDarkie CoderIn": "Po përditëson Darkie Coder në {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Përditëso Darkie Coder në {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Përditëso Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder është gati në {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder është gati.",
  "wsl.onboarding.installDarkie CoderIn": "Instaloni Darkie Coder në {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Instaloni Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Darkie Coder të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Darkie Coder ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Darkie Coder",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (darkie-coder.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Darkie Coder nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Darkie Coder brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Darkie Coder në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Darkie Coder ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Darkie Coder",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Darkie Coder.",

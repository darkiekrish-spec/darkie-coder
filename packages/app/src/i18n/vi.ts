export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Darkie Coder",
  ...
  "desktop.recovery.loadFailed": "Không tải được Darkie Coder",
  "desktop.recovery.terminated": "Cửa sổ Darkie Coder đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Darkie Coder không phản hồi",
  ...
  "desktop.wsl.error.installDarkie Coder": "Không cài đặt được Darkie Coder",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Darkie Coder nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.darkie-coder.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.darkie-coderGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Darkie Coder cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Truy cập ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Darkie Coder.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong darkie-coder.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Darkie Coder mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Đang kiểm tra Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Đang kiểm tra Darkie Coder trong {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Đang cập nhật Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Đang cập nhật Darkie Coder trong {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Cập nhật Darkie Coder trong {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Cập nhật Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder đã sẵn sàng.",
  "wsl.onboarding.installDarkie CoderIn": "Cài đặt Darkie Coder trong {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Cài đặt Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Darkie Coder có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Darkie Coder ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Darkie Coder",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (darkie-coder.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Darkie Coder chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Darkie Coder bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Darkie Coder trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Darkie Coder tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Darkie Coder khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Darkie Coder.",

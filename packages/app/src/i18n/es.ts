export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Darkie Coder",
  ...
  "desktop.menu.ariaLabel": "Menú de Darkie Coder",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Darkie Coder",
  "desktop.recovery.terminated": "La ventana de Darkie Coder se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Darkie Coder no responde",
  ...
  "desktop.wsl.error.installDarkie Coder": "No se pudo instalar Darkie Coder",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder no está instalado en esta distribución",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Darkie Coder finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.darkie-coder.tagline": "Modelos optimizados y fiables",
  "dialog.provider.darkie-coderGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.darkie-coderZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Darkie Coder.",
  ...
  "dialog.plugins.empty": "Plugins configurados en darkie-coder.json",
  ...
  "dialog.server.description": "Cambiar el servidor de Darkie Coder al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Comprobando Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Comprobando Darkie Coder en {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Actualizando Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Actualizando Darkie Coder en {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Actualiza Darkie Coder en {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Actualizar Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder está listo en {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder está listo.",
  "wsl.onboarding.installDarkie CoderIn": "Instala Darkie Coder en {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Instalar Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Darkie Coder pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Darkie Coder ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Darkie Coder",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (darkie-coder.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Darkie Coder aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Darkie Coder dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Darkie Coder en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Darkie Coder sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Darkie Coder",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Darkie Coder.",

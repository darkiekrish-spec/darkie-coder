...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Darkie Coder 加载失败",
  "desktop.recovery.terminated": "Darkie Coder 窗口意外终止",
  "desktop.recovery.unresponsive": "Darkie Coder 未响应",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.darkie-coderMissing": "此发行版中未安装 darkie-coder",
  "desktop.wsl.error.darkie-coderCannotRun": "已安装 darkie-coder，但无法运行",
  "desktop.wsl.error.darkie-coderNotInstalled": "{{distro}} 中未安装 Darkie Coder",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.darkie-coder.tagline": "可靠的优化模型",
  "dialog.provider.darkie-coderGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Darkie Coder 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Darkie Coder 中使用 {{provider}} 模型。",
  ...
  "provider.connect.darkie-coderZen.line1": "Darkie Coder Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.darkie-coderZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.darkie-coderZen.visit.prefix": "访问 ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Darkie Coder 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Darkie Coder 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 darkie-coder.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Darkie Coder 服务器。",
  ...
  "wsl.onboarding.checkingDarkie Coder": "正在检查 Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "正在检查 {{distro}} 中的 Darkie Coder...",
  "wsl.onboarding.updatingDarkie Coder": "正在更新 Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "正在更新 {{distro}} 中的 Darkie Coder...",
  "wsl.onboarding.updateDarkie CoderIn": "更新 {{distro}} 中的 Darkie Coder。",
  "wsl.onboarding.updateDarkie Coder": "更新 Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "{{distro}} 中的 Darkie Coder 已就绪。",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder 已就绪。",
  "wsl.onboarding.installDarkie CoderIn": "在 {{distro}} 中安装 Darkie Coder。",
  "wsl.onboarding.installDarkie Coder": "安装 Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "未安装 Darkie Coder",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Darkie Coder 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Darkie Coder。",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Darkie Coder 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Darkie Coder 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (darkie-coder.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Darkie Coder 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Darkie Coder 服务器。",
  ...
  "settings.general.row.language.description": "更改 Darkie Coder 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Darkie Coder 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Darkie Coder 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Darkie Coder 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Darkie Coder 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Darkie Coder。",

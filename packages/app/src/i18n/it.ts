export const dict = {
  ...
  "dialog.provider.darkie-coder.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.darkie-coder.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.darkie-coderGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.darkie-coderZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.darkie-coderZen.visit.prefix": "Visita ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Darkie Coder.",
  ...
  "dialog.plugins.empty": "Plugin configurati in darkie-coder.json",
  ...
  "dialog.server.description": "Cambia il server Darkie Coder a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Controllo Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Controllo Darkie Coder in {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Aggiornamento Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Aggiornamento Darkie Coder in {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Aggiorna Darkie Coder in {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Aggiorna Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder è pronto in {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder è pronto.",
  "wsl.onboarding.installDarkie CoderIn": "Installa Darkie Coder in {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Installa Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Darkie Coder possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Darkie Coder ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Darkie Coder",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (darkie-coder.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Darkie Coder non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Darkie Coder all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Darkie Coder sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Darkie Coder segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Darkie Coder",
  ...
  "settings.updates.toast.latest.title": "Darkie Coder è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Darkie Coder.",
  ...
  "desktop.menu.documentation": "Documentazione di Darkie Coder",
  ...
  "desktop.menu.ariaLabel": "Menu Darkie Coder",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Darkie Coder",
  "desktop.recovery.terminated": "La finestra di Darkie Coder si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Darkie Coder non risponde",
  ...
  "desktop.wsl.error.installDarkie Coder": "Installazione di Darkie Coder non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder non è installato in questa distribuzione",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Darkie Coder è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",

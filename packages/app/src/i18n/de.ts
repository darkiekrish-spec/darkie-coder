...
export const dict = {
  ...
  "dialog.provider.darkie-coder.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.darkie-coder.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.darkie-coderGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Darkie Coder zu nutzen.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.darkie-coderZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.darkie-coderZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Darkie Coder zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Darkie Coder zu nutzen.",
  ...
  "dialog.plugins.empty": "In darkie-coder.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Darkie Coder-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.darkie-coder": "Darkie Coder",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Darkie Coder wird geprüft…",
  "wsl.onboarding.checkingDarkie CoderIn": "Darkie Coder in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingDarkie Coder": "Darkie Coder wird aktualisiert…",
  "wsl.onboarding.updatingDarkie CoderIn": "Darkie Coder in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateDarkie CoderIn": "Aktualisieren Sie Darkie Coder in {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Darkie Coder aktualisieren",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder ist in {{distro}} bereit.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder ist bereit.",
  "wsl.onboarding.installDarkie CoderIn": "Installieren Sie Darkie Coder in {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Darkie Coder installieren",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Darkie Coder einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Darkie Coder erneut.",
  ...
  "toast.update.description": "Eine neue Version von Darkie Coder ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Darkie Coder-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (darkie-coder.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Darkie Coder unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Darkie Coder mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Darkie Coder Desktop",
  ...
  "settings.desktop.wsl.description": "Darkie Coder-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Darkie Coder ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Darkie Coder auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Darkie Coder dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Darkie Coder anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Darkie Coder automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Darkie Coder ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Darkie Coder wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Darkie Coder-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Darkie Coder reagiert nicht",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Darkie Coder-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":

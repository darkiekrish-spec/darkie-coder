...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Darkie Coder yüklenemedi",
  "desktop.recovery.terminated": "Darkie Coder penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Darkie Coder yanıt vermiyor",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder bu dağıtımda kurulu değil",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.darkie-coder.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.darkie-coderGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Darkie Coder tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Darkie Coder'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.darkie-coderZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Darkie Coder'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Darkie Coder'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler darkie-coder.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Darkie Coder sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Darkie Coder kontrol ediliyor...",
  "wsl.onboarding.checkingDarkie CoderIn": "{{distro}} içinde Darkie Coder kontrol ediliyor...",
  "wsl.onboarding.updatingDarkie Coder": "Darkie Coder güncelleniyor...",
  "wsl.onboarding.updatingDarkie CoderIn": "{{distro}} içinde Darkie Coder güncelleniyor...",
  "wsl.onboarding.updateDarkie CoderIn": "{{distro}} içindeki Darkie Coder'u güncelleyin.",
  "wsl.onboarding.updateDarkie Coder": "Darkie Coder'u güncelle",
  "wsl.onboarding.darkie-coderReadyIn": "{{distro}} içinde Darkie Coder hazır.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder hazır.",
  "wsl.onboarding.installDarkie CoderIn": "Darkie Coder'u {{distro}} içine kurun.",
  "wsl.onboarding.installDarkie Coder": "Darkie Coder'u kur",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Darkie Coder'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Darkie Coder'u tekrar açın.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Darkie Coder'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Darkie Coder ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (darkie-coder.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Darkie Coder henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Darkie Coder Masaüstü",
  ...
  "settings.desktop.wsl.description": "Darkie Coder sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Darkie Coder'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Darkie Coder'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Darkie Coder'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Darkie Coder'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Darkie Coder başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Darkie Coder'un en son sürümünü kullanıyorsunuz.",

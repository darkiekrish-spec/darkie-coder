export const dict = {
  ...
  "desktop.recovery.loadFailed": "Darkie Coder laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Darkie Coder aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Darkie Coder ei vasta",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder pole sellesse distrosse installitud",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.darkie-coder.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.darkie-coderGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Darkie Coder'is.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Külastage ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Darkie Coder.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis darkie-coder.json",
  ...
  "dialog.server.description": "Lülitage, millise Darkie Coder serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Darkie Coder kontrollimine...",
  "wsl.onboarding.checkingDarkie CoderIn": "Darkie Coder kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Darkie Coder värskendamine...",
  "wsl.onboarding.updatingDarkie CoderIn": "Darkie Coder värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Värskenda Darkie Coder jaotises {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Värskenda Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder on valmis {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder on valmis.",
  "wsl.onboarding.installDarkie CoderIn": "Installige Darkie Coder asukohta {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Installige Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Darkie Coder saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Darkie Coder ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Darkie Coder meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (darkie-coder.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Darkie Coder ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Darkie Coder Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Darkie Coder server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Darkie Coder kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Darkie Coder teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Darkie Coder järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Darkie Coder on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Darkie Coder käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Darkie Coder uusimat versiooni.",

export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด Darkie Coder ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง Darkie Coder หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "Darkie Coder ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installDarkie Coder": "การติดตั้ง Darkie Coder ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.darkie-coderMissing": "ไม่ได้ติดตั้ง darkie-coder ในดิสโทรนี้",
  "desktop.wsl.error.darkie-coderCannotRun": "ติดตั้ง darkie-coder แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.darkie-coderNotInstalled": "ไม่ได้ติดตั้ง Darkie Coder ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต Darkie Coder เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.darkie-coder.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.darkie-coderGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Darkie Coder",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  "provider.connect.darkie-coderZen.line2":
    "ด้วยคีย์ API เดียวคุณจะได้รับการเข้าถึงโมเดล เช่น Claude, GPT, Gemini, GLM และอื่น ๆ",
  "provider.connect.darkie-coderZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " เพื่อรับคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Darkie Coder",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Darkie Coder",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน darkie-coder.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Darkie Coder ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingDarkie Coder": "กำลังตรวจสอบ Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "กำลังตรวจสอบ Darkie Coder ใน {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "กำลังอัปเดต Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "กำลังอัปเดต Darkie Coder ใน {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "อัปเดต Darkie Coder ใน {{distro}}",
  "wsl.onboarding.updateDarkie Coder": "อัปเดต Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder พร้อมใช้งานแล้ว",
  "wsl.onboarding.installDarkie CoderIn": "ติดตั้ง Darkie Coder ใน {{distro}}",
  "wsl.onboarding.installDarkie Coder": "ติดตั้ง Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "ยังไม่ได้ติดตั้ง Darkie Coder",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Darkie Coder จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Darkie Coder อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ Darkie Coder Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Darkie Coder ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Darkie Coder",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (darkie-coder.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Darkie Coder ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Darkie Coder ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Darkie Coder",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ Darkie Coder บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Darkie Coder ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ Darkie Coder",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Darkie Coder เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Darkie Coder เวอร์ชันล่าสุด",

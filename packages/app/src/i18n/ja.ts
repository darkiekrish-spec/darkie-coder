export const dict = {
  ...
  "desktop.recovery.loadFailed": "Darkie Coderを読み込めませんでした",
  "desktop.recovery.terminated": "Darkie Coderのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Darkie Coderが応答していません",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coderのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.darkie-coderMissing": "このディストリビューションにはdarkie-coderがインストールされていません",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coderはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.darkie-coderNotInstalled": "{{distro}}にはDarkie Coderがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Darkie Coderのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.darkie-coder.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.darkie-coder.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.darkie-coderGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Darkie Coderが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Darkie Coderで{{provider}}モデルを使用します。",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.darkie-coderZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.darkie-coderZen.visit.prefix": " ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してDarkie Coderで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Darkie Coderで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "darkie-coder.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するDarkie Coderサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Darkie Coderを確認中...",
  "wsl.onboarding.checkingDarkie CoderIn": "{{distro}}内のDarkie Coderを確認中...",
  "wsl.onboarding.updatingDarkie Coder": "Darkie Coderを更新中...",
  "wsl.onboarding.updatingDarkie CoderIn": "{{distro}}内のDarkie Coderを更新中...",
  "wsl.onboarding.updateDarkie CoderIn": "{{distro}}内のDarkie Coderを更新してください。",
  "wsl.onboarding.updateDarkie Coder": "Darkie Coderを更新",
  "wsl.onboarding.darkie-coderReadyIn": "{{distro}}内のDarkie Coderの準備ができました。",
  "wsl.onboarding.darkie-coderReady": "Darkie Coderの準備ができました。",
  "wsl.onboarding.installDarkie CoderIn": "{{distro}}にDarkie Coderをインストールしてください。",
  "wsl.onboarding.installDarkie Coder": "Darkie Coderをインストール",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coderがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Darkie CoderでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Darkie Coderをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Darkie Coder Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Darkie Coderの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをDarkie Coderチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (darkie-coder.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: Darkie CoderはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coderには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でDarkie Coderサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Darkie Coderの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのDarkie Coderの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Darkie Coderがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Darkie Coderのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Darkie Coder の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Darkie Coder は最新バージョンです。",

export const dict = {
  ...
  "desktop.menu.documentation": "Darkie Coder-documentatie",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder kan niet worden geladen",
  "desktop.recovery.terminated": "Het Darkie Coder-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Darkie Coder reageert niet",
  ...
  "desktop.wsl.error.installDarkie Coder": "Installatie van Darkie Coder is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Darkie Coder-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.darkie-coder.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.darkie-coderGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Darkie Coder te gebruiken.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Ga naar ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Darkie Coder te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Darkie Coder te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in darkie-coder.json",
  ...
  "dialog.server.description": "Wijzig met welke Darkie Coder-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Darkie Coder controleren...",
  "wsl.onboarding.checkingDarkie CoderIn": "Darkie Coder controleren in {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Darkie Coder bijwerken...",
  "wsl.onboarding.updatingDarkie CoderIn": "Darkie Coder bijwerken in {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Werk Darkie Coder bij in {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Darkie Coder bijwerken",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder is gereed in {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder is klaar.",
  "wsl.onboarding.installDarkie CoderIn": "Installeer Darkie Coder in {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Installeer Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Darkie Coder een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Darkie Coder opnieuw.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Darkie Coder ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Darkie Coder-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (darkie-coder.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Darkie Coder ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Darkie Coder-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Darkie Coder eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Darkie Coder het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Darkie Coder aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Darkie Coder wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Darkie Coder is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Darkie Coder.",

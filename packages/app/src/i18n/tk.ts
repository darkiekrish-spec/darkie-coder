export const dict = {
  ...
  "desktop.menu.documentation": "Darkie Coder Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Darkie Coder menýusy",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder ýükläp bilmedi",
  "desktop.recovery.terminated": "Darkie Coder penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Darkie Coder jogap berenok",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.darkie-coderMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.darkie-coder.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.darkie-coderGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Darkie Coder tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Darkie Coder-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Sapar ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Darkie Coder-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Darkie Coder-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "darkie-coder.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Darkie Coder serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Darkie Coder barlamak ...",
  "wsl.onboarding.checkingDarkie CoderIn": "{{distro}} içinde Darkie Coder barlanýar...",
  "wsl.onboarding.updatingDarkie Coder": "Darkie Coder täzelenmek ...",
  "wsl.onboarding.updatingDarkie CoderIn": "{{distro}}-de Darkie Coder täzelenmek ...",
  "wsl.onboarding.updateDarkie CoderIn": "Darkie Coder-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateDarkie Coder": "Darkie Coder täzeläň",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder {{distro}}-de taýýar.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder taýýar.",
  "wsl.onboarding.installDarkie CoderIn": "{{distro}}-de Darkie Coder guruň.",
  "wsl.onboarding.installDarkie Coder": "Darkie Coder guruň",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Darkie Coder WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Darkie Coder açyň.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Darkie Coder ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Darkie Coder toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (darkie-coder.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Darkie Coder entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Darkie Coder serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Darkie Coder üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Darkie Coder enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "Darkie Coder ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Darkie Coder-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Darkie Coder işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Darkie Coder-iň iň soňky wersiýasyny işleýärsiňiz.",

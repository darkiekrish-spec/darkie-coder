export const dict = {
  ...
  "desktop.menu.documentation": "Darkie Coder Skjøl",
  ...
  "desktop.menu.ariaLabel": "Darkie Coder valmynd",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder miseydnaðist at heinta",
  "desktop.recovery.terminated": "Darkie Coder vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Darkie Coder svarar ikki",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder er ikki sett upp í hesi distro",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder er sett upp men kundi ikki koyra",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.darkie-coder.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.darkie-coder.tagline": "Álítandi optimerað modell",
  "dialog.provider.darkie-coderGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Vitja ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Darkie Coder.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í darkie-coder.json",
  ...
  "dialog.server.description": "Skift hvønn Darkie Coder ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Kanna Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Kanna Darkie Coder í {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Dagføring Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Dagføring Darkie Coder í {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Dagfør Darkie Coder í {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Dagfør Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder er klárt í {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder er klárt.",
  "wsl.onboarding.installDarkie CoderIn": "Set Darkie Coder upp í {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Set upp Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Darkie Coder kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Darkie Coder aftur.",
  ...
  "help.tabs.introduction": "Darkie Coder Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Darkie Coder ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Darkie Coder toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (darkie-coder.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Darkie Coder stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Darkie Coder Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Darkie Coder ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Darkie Coder sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Darkie Coder fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Darkie Coder er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Darkie Coder byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Darkie Coder.",

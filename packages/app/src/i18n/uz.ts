export const dict = {
  ...
  "desktop.menu.documentation": "Darkie Coder hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Darkie Coder menyusi",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder yuklanmadi",
  "desktop.recovery.terminated": "Darkie Coder oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Darkie Coder javob bermayapti",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.darkie-coderMissing": "Darkie Coder ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.darkie-coder.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.darkie-coderGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Darkie Coder tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Darkie Coder’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Darkie Coder da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Darkie Coder da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "darkie-coder.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Darkie Coder serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Darkie Coder tekshirilmoqda...",
  "wsl.onboarding.checkingDarkie CoderIn": "Darkie Coder {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingDarkie Coder": "Darkie Coder yangilanmoqda...",
  "wsl.onboarding.updatingDarkie CoderIn": "Darkie Coder {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateDarkie CoderIn": "Darkie Coder-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateDarkie Coder": "Darkie Coder-ni yangilang",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder {{distro}} da tayyor.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder tayyor.",
  "wsl.onboarding.installDarkie CoderIn": "Darkie Coder-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installDarkie Coder": "Darkie Coder-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Darkie Coder WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Darkie Coder-ni qayta oching.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Darkie Coder ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Darkie Coder jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (darkie-coder.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Darkie Coder hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Darkie Coder bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Darkie Coder serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Darkie Coder uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Darkie Coder qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Darkie Coder tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Darkie Coder mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Darkie Coder ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Darkie Coder oxirgi versiyasini ishga tushiryapsiz.",

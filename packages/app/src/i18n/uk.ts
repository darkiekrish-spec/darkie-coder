export const dict = {
  ...
  "desktop.menu.documentation": "Документація Darkie Coder",
  ...
  "desktop.menu.ariaLabel": "Меню Darkie Coder",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Darkie Coder",
  "desktop.recovery.terminated": "Роботу вікна Darkie Coder несподівано завершено",
  "desktop.recovery.unresponsive": "Darkie Coder не відповідає",
  ...
  "desktop.wsl.error.installDarkie Coder": "Не вдалося встановити Darkie Coder",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder встановлено, але його не вдалося запустити",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Darkie Coder завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.darkie-coder.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.darkie-coderGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Відвідайте ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Darkie Coder.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в darkie-coder.json",
  ...
  "dialog.server.description": "Перемкніть сервер Darkie Coder, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Перевірка Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Перевірка Darkie Coder у {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Оновлення Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Оновлення Darkie Coder у {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Оновіть Darkie Coder у {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Оновити Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder готовий до роботи у {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder готовий до роботи.",
  "wsl.onboarding.installDarkie CoderIn": "Встановіть Darkie Coder у {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Встановити Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Darkie Coder потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Darkie Coder ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Darkie Coder",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (darkie-coder.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Darkie Coder ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Darkie Coder всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Darkie Coder на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Darkie Coder використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Darkie Coder",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Darkie Coder.",

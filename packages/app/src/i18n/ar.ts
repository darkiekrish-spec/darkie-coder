export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Darkie Coder",
  "desktop.recovery.terminated": "توقفت نافذة Darkie Coder بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Darkie Coder لا يستجيب",
  ...
  "desktop.wsl.error.installDarkie Coder": "فشل تثبيت Darkie Coder",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Darkie Coder، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.darkie-coder.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.darkie-coderGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "يمنحك Darkie Coder Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "قم بزيارة ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Darkie Coder.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في darkie-coder.json",
  ...
  "dialog.server.description": "تبديل خادم Darkie Coder الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "جارٍ التحقق من Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "جارٍ التحقق من Darkie Coder في {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "جارٍ تحديث Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "جارٍ تحديث Darkie Coder في {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "حدّث Darkie Coder في {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "تحديث Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder جاهز في {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder جاهز.",
  "wsl.onboarding.installDarkie CoderIn": "ثبّت Darkie Coder في {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "تثبيت Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Darkie Coder من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Darkie Coder التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Darkie Coder.",
  ...
  "help.tabs.introduction": "أصبح Darkie Coder Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Darkie Coder ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Darkie Coder",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (darkie-coder.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Darkie Coder لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Darkie Coder نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Darkie Coder داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Darkie Coder",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Darkie Coder على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Darkie Coder يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Darkie Coder",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Darkie Coder.",

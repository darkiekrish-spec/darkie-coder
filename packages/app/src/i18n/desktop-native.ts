...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Darkie Coder failed to load",
  "desktop.recovery.terminated": "Darkie Coder window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Darkie Coder is not responding",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder is not installed in this distro",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder is installed but could not run",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder update finished but {{distro}} still reports {{installed}}; expected {{expected}}",

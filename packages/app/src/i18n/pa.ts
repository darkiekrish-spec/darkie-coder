export const dict = {
  ...
  "desktop.menu.documentation": "Darkie Coder دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Darkie Coder دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Darkie Coder جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.darkie-coderMissing": "اس ڈسٹرو وچ darkie-coder انسٹال نئیں اے",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.darkie-coderNotInstalled": "{{distro}} وچ Darkie Coder انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.darkie-coder.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.darkie-coder.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.darkie-coderGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Darkie Coder دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Darkie Coder وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "ویکھو ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Darkie Coder وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Darkie Coder وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "darkie-coder.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس Darkie Coder سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Darkie Coder چیک کر رئے آں...",
  "wsl.onboarding.checkingDarkie CoderIn": "{{distro}} چ Darkie Coder دی جانچ پڑتال...",
  "wsl.onboarding.updatingDarkie Coder": "Darkie Coder نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingDarkie CoderIn": "{{distro}} وچ Darkie Coder نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateDarkie CoderIn": "{{distro}} وچ Darkie Coder نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateDarkie Coder": "Darkie Coder اپ ڈیٹ کرو",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder {{distro}} چ تیار اے۔",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder تیار اے۔",
  "wsl.onboarding.installDarkie CoderIn": "{{distro}} وچ Darkie Coder انسٹال کرو۔",
  "wsl.onboarding.installDarkie Coder": "Darkie Coder انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Darkie Coder دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Darkie Coder دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Darkie Coder ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Darkie Coder ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (darkie-coder.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Darkie Coder ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Darkie Coder سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Darkie Coder لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Darkie Coder کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Darkie Coder سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Darkie Coder نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Darkie Coder لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Darkie Coder دا تازہ ترین ورژن چلا رئے او۔",

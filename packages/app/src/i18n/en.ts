...
export const dict = {
  ...
  "dialog.provider.darkie-coder.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.darkie-coder.tagline": "Reliable optimized models",
  "dialog.provider.darkie-coderGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Darkie Coder.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.darkie-coderZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.darkie-coderZen.visit.prefix": "Visit ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Darkie Coder.",
  ...
  "dialog.plugins.empty": "Plugins configured in darkie-coder.json",
  ...
  "dialog.server.description": "Switch which Darkie Coder server this app connects to.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Checking Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Checking Darkie Coder in {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Updating Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Updating Darkie Coder in {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Update Darkie Coder in {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Update Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder is ready in {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder is ready.",
  "wsl.onboarding.installDarkie CoderIn": "Install Darkie Coder in {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Install Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Darkie Coder can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Darkie Coder ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Darkie Coder team",
  ...
  "error.chain.checkConfig": "Check your config (darkie-coder.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Darkie Coder does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Darkie Coder server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Darkie Coder",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Darkie Coder looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Darkie Coder follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Darkie Coder is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Darkie Coder launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Darkie Coder.",

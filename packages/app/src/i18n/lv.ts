export const dict = {
  ...
  "desktop.menu.documentation": "Darkie Coder dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Darkie Coder izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Darkie Coder",
  "desktop.recovery.terminated": "Darkie Coder logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Darkie Coder neatbild",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder nav instalēts šajā distribūcijā",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.darkie-coder.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.darkie-coderGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Apmeklējiet",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Darkie Coder.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti darkie-coder.json",
  ...
  "dialog.server.description": "Mainiet, pie kura Darkie Coder servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Pārbaudu Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Pārbaudu Darkie Coder distribūcijā {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Atjauninu Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Atjauninu Darkie Coder distribūcijā {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Atjauniniet Darkie Coder distribūcijā {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Atjauniniet Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder ir gatavs.",
  "wsl.onboarding.installDarkie CoderIn": "Instalējiet Darkie Coder distribūcijā {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Instalējiet Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Darkie Coder var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Darkie Coder no jauna.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Darkie Coder versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Darkie Coder komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (darkie-coder.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Darkie Coder vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "Darkie Coder darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Darkie Coder serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Darkie Coder saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Darkie Coder izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai Darkie Coder sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Darkie Coder tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Darkie Coder",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Darkie Coder versiju.",

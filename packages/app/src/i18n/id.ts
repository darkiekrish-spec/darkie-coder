export const dict = {
  ...
  "desktop.recovery.loadFailed": "Darkie Coder gagal dimuat",
  "desktop.recovery.terminated": "Jendela Darkie Coder berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Darkie Coder tidak merespons",
  ...
  "desktop.wsl.error.installDarkie Coder": "Instalasi Darkie Coder gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder belum terinstal di distro ini",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Darkie Coder selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.darkie-coder.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.darkie-coderGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Darkie Coder.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di darkie-coder.json",
  ...
  "dialog.server.description": "Ganti server Darkie Coder mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Memeriksa Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Memeriksa Darkie Coder di {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Memperbarui Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Memperbarui Darkie Coder di {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Perbarui Darkie Coder di {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Perbarui Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder siap di {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder siap.",
  "wsl.onboarding.installDarkie CoderIn": "Instal Darkie Coder di {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Instal Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Darkie Coder dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Darkie Coder ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Darkie Coder",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (darkie-coder.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Darkie Coder belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Darkie Coder di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Darkie Coder di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Darkie Coder mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Darkie Coder diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Darkie Coder.",

export const dict = {
  ...
  "dialog.provider.darkie-coder.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.darkie-coder.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.darkie-coderGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "Darkie Codern tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Darkie Coderssa.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Avaa ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Darkie Coderssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Darkie Coderssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään darkie-coder.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Darkie Coder-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Tarkistetaan Darkie Codera...",
  "wsl.onboarding.checkingDarkie CoderIn": "Tarkistetaan Darkie Codera kohteessa {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Päivitetään Darkie Codera...",
  "wsl.onboarding.updatingDarkie CoderIn": "Päivitetään Darkie Codera kohteessa {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Päivitä Darkie Coder jakelussa {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Päivitä Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder on valmis jakelussa {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder on valmis.",
  "wsl.onboarding.installDarkie CoderIn": "Asenna Darkie Coder jakeluun {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Asenna Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Codera ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Darkie Coder voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Darkie Coder uudelleen.",
  ...
  "toast.update.description": "Darkie Codern uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Darkie Coder-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (darkie-coder.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Darkie Coder ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Darkie Coder-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Darkie Codern näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Darkie Coder näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Darkie Coder järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Darkie Codern teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Darkie Coder käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Darkie Codern uusinta versiota.",
  ...
  "desktop.menu.documentation": "Darkie Coder-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Darkie Coder-valikko",
  ...
  "desktop.recovery.loadFailed": "Darkie Codern lataaminen epäonnistui",
  "desktop.recovery.terminated": "Darkie Coder-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Darkie Coder ei vastaa",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Codern asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.darkie-coderMissing": "darkie-codera ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Codera ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Darkie Codern päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":

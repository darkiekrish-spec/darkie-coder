export const dict = {
  ...
  "desktop.recovery.loadFailed": "Darkie Coder kunde inte läsas in",
  "desktop.recovery.terminated": "Darkie Coder-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Darkie Coder svarar inte",
  ...
  "desktop.wsl.error.installDarkie Coder": "Installationen av Darkie Coder misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder är inte installerat i den här distributionen",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder är installerat men kunde inte köras",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.darkie-coder.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.darkie-coder.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.darkie-coderGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Besök ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Darkie Coder.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i darkie-coder.json",
  ...
  "dialog.server.description": "Växla vilken Darkie Coder-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Kontrollerar Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Kontrollerar Darkie Coder i {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Uppdaterar Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Uppdaterar Darkie Coder i {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Uppdatera Darkie Coder i {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Uppdatera Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder är redo i {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder är redo.",
  "wsl.onboarding.installDarkie CoderIn": "Installera Darkie Coder i {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Installera Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Darkie Coder kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Darkie Coder igen.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Darkie Coder ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Darkie Coder-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (darkie-coder.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Darkie Coder stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Darkie Coder-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Darkie Coder ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Darkie Coder följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Darkie Coders tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Darkie Coder startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Darkie Coder.",

export const dict = {
  ...
  "desktop.menu.documentation": "Darkie Coder Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Darkie Coder",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder se nepodařilo načíst",
  "desktop.recovery.terminated": "Darkie Coder okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Darkie Coder nereaguje",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder není v této distribuci nainstalováno",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.darkie-coder.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.darkie-coderGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Návštěva ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Darkie Coder.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v darkie-coder.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Darkie Coder serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Kontrola Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Kontrola Darkie Coder v {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Aktualizace Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Aktualizace Darkie Coder v {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Aktualizace Darkie Coder v {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Aktualizovat Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder je připraveno v {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder je připraven.",
  "wsl.onboarding.installDarkie CoderIn": "Nainstalujte Darkie Coder do {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Instalovat Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Darkie Coder může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Darkie Coder ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Darkie Coder",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (darkie-coder.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Darkie Coder zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Darkie Coder uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Darkie Coder na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Darkie Coder následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Darkie Coder",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Darkie Coder.",

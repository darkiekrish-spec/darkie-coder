export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Darkie Coder",
  ...
  "desktop.menu.ariaLabel": "Meniu Darkie Coder",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Darkie Coder s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Darkie Coder nu răspunde",
  ...
  "desktop.wsl.error.installDarkie Coder": "Instalarea Darkie Coder a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder nu este instalat în această distribuție",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Darkie Coder s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.darkie-coder.tagline": "Modele optimizate, fiabile",
  "dialog.provider.darkie-coderGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.darkie-coderZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.darkie-coderZen.visit.prefix": "Vizitează",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Darkie Coder.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în darkie-coder.json",
  ...
  "dialog.server.description": "Schimbă serverul Darkie Coder la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Se verifică Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Se verifică Darkie Coder în {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Se actualizează Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Se actualizează Darkie Coder în {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Actualizează Darkie Coder în {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Actualizează Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder este gata în {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder este gata.",
  "wsl.onboarding.installDarkie CoderIn": "Instalează Darkie Coder în {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Instalează Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Darkie Coder să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Darkie Coder ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Darkie Coder",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (darkie-coder.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Darkie Coder nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Darkie Coder în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Darkie Coder pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Darkie Coder urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Darkie Coder",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Darkie Coder.",

export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Darkie Coder",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Darkie Coder ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Darkie Coder tidak memberi respons",
  ...
  "desktop.wsl.error.installDarkie Coder": "Pemasangan Darkie Coder gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder tidak dipasang dalam distro ini",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Darkie Coder selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.darkie-coder.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.darkie-coderGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Layari",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Darkie Coder.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam darkie-coder.json",
  ...
  "dialog.server.description": "Tukar pelayan Darkie Coder yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Sedang menyemak Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Sedang menyemak Darkie Coder dalam {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Sedang mengemas kini Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Sedang mengemas kini Darkie Coder dalam {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Kemas kini Darkie Coder dalam {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Kemas kini Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder sedia digunakan.",
  "wsl.onboarding.installDarkie CoderIn": "Pasang Darkie Coder dalam {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Pasang Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Darkie Coder boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Darkie Coder ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Darkie Coder",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (darkie-coder.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Darkie Coder belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Darkie Coder dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Darkie Coder pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Darkie Coder mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Darkie Coder dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Darkie Coder.",

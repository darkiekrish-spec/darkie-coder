export const dict = {
  ...
  "desktop.menu.documentation": "Darkie Coder Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Darkie Coder μενού",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Darkie Coder το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Darkie Coder δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.darkie-coderMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.darkie-coderCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.darkie-coder.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.darkie-coderGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  "provider.connect.oauth.code.visit.prefix": "Επίσκεψη ",
  "provider.connect.oauth.code.visit.link": "αυτός ο σύνδεσμος",
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Darkie Coder.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο darkie-coder.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Darkie Coder συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Έλεγχος Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Έλεγχος Darkie Coder σε {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Ενημέρωση Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Ενημέρωση Darkie Coder σε {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Ενημέρωση Darkie Coder σε {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Ενημέρωση Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder είναι έτοιμο.",
  "wsl.onboarding.installDarkie CoderIn": "Εγκατάσταση του Darkie Coder στο {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Εγκατάσταση Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Darkie Coder να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Darkie Coder ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Darkie Coder",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (darkie-coder.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Darkie Coder δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Darkie Coder Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Darkie Coder μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Darkie Coder στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Darkie Coder ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Darkie Coder",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Darkie Coder.",

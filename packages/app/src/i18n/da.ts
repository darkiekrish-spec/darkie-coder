export const dict = {
  ...
  "dialog.provider.darkie-coder.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.darkie-coder.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.darkie-coderGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Besøg ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Darkie Coder.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i darkie-coder.json",
  ...
  "dialog.server.description": "Skift hvilken Darkie Coder-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Tjekker Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Tjekker Darkie Coder i {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Opdaterer Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Opdaterer Darkie Coder i {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Opdater Darkie Coder i {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Opdater Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Darkie Coder kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Darkie Coder igen.",
  ...
  "toast.update.description": "En ny version af Darkie Coder ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Darkie Coder-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (darkie-coder.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Darkie Coder understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Darkie Coder-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Darkie Coder ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Darkie Coder skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Darkie Coders tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Darkie Coder starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Darkie Coder.",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder kunne ikke indlæses",
  "desktop.recovery.terminated": "Darkie Coder-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installDarkie Coder": "Installationen af Darkie Coder mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder er ikke installeret i denne distribution",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder er installeret, men kunne ikke køre",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Darkie Coder er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":

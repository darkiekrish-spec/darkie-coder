export const dict = {
  ...
  "desktop.menu.documentation": "Darkie Coder Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Darkie Coder.",
  ...
  "desktop.recovery.loadFailed": "Darkie Coder no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Darkie Coder s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Darkie Coder no respon",
  ...
  "desktop.wsl.error.installDarkie Coder": "La instal·lació de Darkie Coder ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder no està instal·lat en aquesta distribució",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.darkie-coder.tagline": "Models optimitzats fiables",
  "dialog.provider.darkie-coderGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.darkie-coderZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Darkie Coder.",
  ...
  "dialog.plugins.empty": "Connectors configurats a darkie-coder.json",
  ...
  "dialog.server.description": "Canvia a quin Darkie Coder servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "S'està comprovant Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "S'està registrant Darkie Coder a {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "S'està actualitzant Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "S'està actualitzant Darkie Coder a {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Actualitza Darkie Coder a {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Actualització Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder està llest a {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder està llest.",
  "wsl.onboarding.installDarkie CoderIn": "Instal·leu Darkie Coder a {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Instal·la Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Darkie Coder pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Darkie Coder ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Darkie Coder.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (darkie-coder.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Darkie Coder encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Darkie Coder Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Darkie Coder dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Darkie Coder al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Darkie Coder segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Darkie Coder.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Darkie Coder.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Darkie Coder.",

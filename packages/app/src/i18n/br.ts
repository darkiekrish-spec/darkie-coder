export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Darkie Coder",
  ...
  "desktop.menu.ariaLabel": "Menu do Darkie Coder",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Darkie Coder",
  "desktop.recovery.terminated": "A janela do Darkie Coder foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Darkie Coder não está respondendo",
  ...
  "desktop.wsl.error.installDarkie Coder": "Falha na instalação do Darkie Coder",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.darkie-coderMissing": "O darkie-coder não está instalado nesta distribuição",
  "desktop.wsl.error.darkie-coderCannotRun": "O darkie-coder está instalado, mas não pôde ser executado",
  "desktop.wsl.error.darkie-coderNotInstalled": "O Darkie Coder não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Darkie Coder foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.darkie-coder.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.darkie-coderGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Visite ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Darkie Coder.",
  ...
  "dialog.plugins.empty": "Plugins configurados em darkie-coder.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Darkie Coder este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Verificando o Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Verificando o Darkie Coder em {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Atualizando o Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Atualizando o Darkie Coder em {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Atualize o Darkie Coder em {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Atualizar o Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "O Darkie Coder está pronto em {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "O Darkie Coder está pronto.",
  "wsl.onboarding.installDarkie CoderIn": "Instale o Darkie Coder em {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Instalar o Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Darkie Coder possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Darkie Coder não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Darkie Coder novamente.",
  ...
  "help.tabs.introduction": "Agora, o Darkie Coder Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Darkie Coder ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Darkie Coder",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (darkie-coder.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Darkie Coder ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Darkie Coder dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Personalize como o Darkie Coder aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Darkie Coder segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Darkie Coder é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Darkie Coder iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Darkie Coder.",

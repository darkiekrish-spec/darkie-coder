...
const desktop = [
  ...
  "Kilépés",
  "Az Darkie Coder betöltése sikertelen",
  "Az Darkie Coder ablaka váratlanul leállt",
  "Az Darkie Coder nem válaszol",
  ...
  "Az Darkie Coder telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az darkie-coder nincs telepítve ebben a disztribúcióban",
  "Az darkie-coder telepítve van, de nem futtatható",
  "Az Darkie Coder nincs telepítve ebben: {{distro}}",
  "Az Darkie Coder frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.darkie-coder.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.darkie-coder.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.darkie-coderGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A Darkie Coder ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a Darkie Coder-ben.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "A Darkie Coder Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Látogatás",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a Darkie Coder-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a Darkie Coder-ben.",
  ...
  "dialog.plugins.empty": "Az darkie-coder.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik Darkie Coder szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Darkie Coder ellenőrzése...",
  "wsl.onboarding.checkingDarkie CoderIn": "Darkie Coder ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingDarkie Coder": "Darkie Coder frissítése...",
  "wsl.onboarding.updatingDarkie CoderIn": "Darkie Coder frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateDarkie CoderIn": "Frissítse a Darkie Coder-t a {{distro}}-ben.",
  "wsl.onboarding.updateDarkie Coder": "Frissítse a Darkie Coder-t",
  "wsl.onboarding.darkie-coderReadyIn": "A Darkie Coder készen áll a {{distro}}-ben.",
  "wsl.onboarding.darkie-coderReady": "A Darkie Coder készen áll.",
  "wsl.onboarding.installDarkie CoderIn": "Telepítse a Darkie Coder-t a {{distro}}-be.",
  "wsl.onboarding.installDarkie Coder": "Telepítse a Darkie Coder-t",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "A Darkie Coder nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a Darkie Coder hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A Darkie Coder nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a Darkie Coder programot.",
  ...
  "help.tabs.introduction": "A Darkie Coder Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Darkie Coder ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Darkie Coder csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (darkie-coder.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a Darkie Coder még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A Darkie Coder ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "Darkie Coder asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a Darkie Coder szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a Darkie Coder kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Darkie Coder az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Darkie Coder a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Darkie Coder témáját.",
  ...
  "settings.updates.row.startup.description": "A Darkie Coder indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a Darkie Coder legújabb verzióját futtatja.",

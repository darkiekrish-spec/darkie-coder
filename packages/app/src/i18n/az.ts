export const dict = {
  ...
  "desktop.recovery.loadFailed": "Darkie Coder yüklənə bilmədi",
  "desktop.recovery.terminated": "Darkie Coder pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Darkie Coder cavab vermir",
  ...
  "desktop.wsl.error.installDarkie Coder": "Darkie Coder quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.darkie-coderMissing": "Bu distribütivdə darkie-coder quraşdırılmayıb",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Darkie Coder yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.darkie-coder.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.darkie-coderGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "Darkie Coder tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Darkie Coder-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Darkie Coder-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Darkie Coder-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər darkie-coder.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Darkie Coder serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Darkie Coder yoxlanılır...",
  "wsl.onboarding.checkingDarkie CoderIn": "{{distro}}-də Darkie Coder yoxlanılır...",
  "wsl.onboarding.updatingDarkie Coder": "Darkie Coder yenilənir...",
  "wsl.onboarding.updatingDarkie CoderIn": "{{distro}}-də Darkie Coder yenilənir...",
  "wsl.onboarding.updateDarkie CoderIn": "{{distro}}-də Darkie Coder-u yeniləyin.",
  "wsl.onboarding.updateDarkie Coder": "Darkie Coder-u yeniləyin",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder {{distro}}-də hazırdır.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder hazırdır.",
  "wsl.onboarding.installDarkie CoderIn": "Darkie Coder-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installDarkie Coder": "Darkie Coder quraşdırın",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Darkie Coder WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Darkie Coder-u yenidən açın.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Darkie Coder-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Darkie Coder komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (darkie-coder.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Darkie Coder hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Darkie Coder serverini işlət.",
  ...
  "settings.general.row.language.description": "Darkie Coder üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Darkie Coder-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Darkie Coder-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Darkie Coder-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Darkie Coder açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Darkie Coder-un ən son versiyasından istifadə edirsiniz.",

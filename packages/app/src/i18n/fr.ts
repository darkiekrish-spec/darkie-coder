export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Darkie Coder",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Darkie Coder",
  "desktop.recovery.terminated": "La fenêtre Darkie Coder s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Darkie Coder ne répond pas",
  ...
  "desktop.wsl.error.installDarkie Coder": "Échec de l'installation d'Darkie Coder",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.darkie-coderMissing": "darkie-coder n'est pas installé dans cette distribution",
  "desktop.wsl.error.darkie-coderCannotRun": "darkie-coder est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.darkie-coderNotInstalled": "Darkie Coder n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Darkie Coder est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.darkie-coder.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.darkie-coder.tagline": "Modèles optimisés et fiables",
  "dialog.provider.darkie-coderGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Visitez ",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Darkie Coder.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans darkie-coder.json",
  ...
  "dialog.server.description": "Changez le serveur Darkie Coder auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Vérification d'Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Vérification d'Darkie Coder dans {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Mise à jour d'Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Mise à jour d'Darkie Coder dans {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Mettez à jour Darkie Coder dans {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Mettre à jour Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder est prêt dans {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder est prêt.",
  "wsl.onboarding.installDarkie CoderIn": "Installez Darkie Coder dans {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Installer Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Darkie Coder puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Darkie Coder ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Darkie Coder",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (darkie-coder.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Darkie Coder ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Darkie Coder inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Darkie Coder dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Darkie Coder sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Darkie Coder suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Darkie Coder.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Darkie Coder",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Darkie Coder.",

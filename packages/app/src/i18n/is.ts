...
const desktop = [
  ...
  "Lágmarka",
  "Hámarka",
  "Darkie Coder skjölun",
  "Aðstoðarspjallborð",
  "Deila ábendingu",
  "Tilkynna villu",
  "Darkie Coder-valmynd",
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Darkie Coder",
  "Darkie Coder-glugganum var óvænt lokað",
  "Darkie Coder svarar ekki",
  ...
  "Uppsetning Darkie Coder mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "darkie-coder er ekki uppsett í þessari dreifingu",
  "darkie-coder er uppsett en ekki var hægt að keyra það",
  "Darkie Coder er ekki uppsett í {{distro}}",
  "Uppfærslu Darkie Coder lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.darkie-coder.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.darkie-coder.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.darkie-coderGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Darkie Coder",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.darkie-coderZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.darkie-coderZen.visit.prefix": "Heimsókn",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Darkie Coder.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í darkie-coder.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Darkie Coder miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Athugar Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Athugar Darkie Coder í {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Uppfærir Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Uppfærir Darkie Coder í {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Uppfærðu Darkie Coder í {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Uppfærðu Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder er tilbúið í {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder er tilbúinn.",
  "wsl.onboarding.installDarkie CoderIn": "Settu upp Darkie Coder í {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Settu upp Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Darkie Coder getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Darkie Coder aftur.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Darkie Coder ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Darkie Coder teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (darkie-coder.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Darkie Coder styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Darkie Coder skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Darkie Coder netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Darkie Coder",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Darkie Coder lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Darkie Coder fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Darkie Coder er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Darkie Coder ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Darkie Coder.",

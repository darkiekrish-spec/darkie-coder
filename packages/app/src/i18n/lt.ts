...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Darkie Coder įkelti nepavyko",
  "Darkie Coder langas netikėtai užsidarė",
  "Darkie Coder neatsako",
  ...
  "Darkie Coder įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "darkie-coder šiame distributyve neįdiegtas",
  "darkie-coder įdiegtas, bet jo paleisti nepavyko",
  "Darkie Coder neįdiegtas distributyve {{distro}}",
  "Darkie Coder naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.darkie-coder.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.darkie-coder.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.darkie-coderGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Darkie Coder modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Darkie Coder.",
  ...
  "provider.connect.darkie-coderZen.line1":
    "Darkie Coder Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.darkie-coderZen.visit.prefix": "Aplankykite",
  "provider.connect.darkie-coderZen.visit.link": "darkie-coder.ai/zen",
  "provider.connect.darkie-coderZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Darkie Coder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Darkie Coder.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti darkie-coder.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Darkie Coder serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingDarkie Coder": "Tikrinama Darkie Coder...",
  "wsl.onboarding.checkingDarkie CoderIn": "Tikrinama Darkie Coder {{distro}}...",
  "wsl.onboarding.updatingDarkie Coder": "Atnaujinamas Darkie Coder...",
  "wsl.onboarding.updatingDarkie CoderIn": "Atnaujinamas Darkie Coder {{distro}}...",
  "wsl.onboarding.updateDarkie CoderIn": "Atnaujinkite Darkie Coder {{distro}}.",
  "wsl.onboarding.updateDarkie Coder": "Atnaujinkite Darkie Coder",
  "wsl.onboarding.darkie-coderReadyIn": "Darkie Coder yra paruoštas {{distro}}.",
  "wsl.onboarding.darkie-coderReady": "Darkie Coder yra paruoštas.",
  "wsl.onboarding.installDarkie CoderIn": "Įdiekite Darkie Coder į {{distro}}.",
  "wsl.onboarding.installDarkie Coder": "Įdiekite Darkie Coder",
  ...
  "wsl.onboarding.distroStatus.darkie-coderMissing": "Darkie Coder neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Darkie Coder galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Darkie Coder nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Darkie Coder.",
  ...
  "help.tabs.introduction": "Darkie Coder Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Darkie Coder ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Darkie Coder komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (darkie-coder.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Darkie Coder dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Darkie Coder apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Darkie Coder darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Darkie Coder serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Darkie Coder ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Darkie Coder atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Darkie Coder seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Darkie Coder temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Darkie Coder",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Darkie Coder versiją.",

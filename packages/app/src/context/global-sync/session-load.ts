...
import type { Darkie CoderClient } from "@opencode-ai/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: Darkie CoderClient; directory: string; limit: number }) {
  try {

import type { Darkie CoderEvent, SessionMessageInfo, SessionPendingMessage } from "@opencode-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: Darkie CoderEvent): V2SessionReduction | undefined => {

  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://darkie-coder.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://darkie-coder.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://darkie-coder.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://darkie-coder.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://darkie-coder.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://darkie-coder.example.com"),
      ),
    ).toEqual({

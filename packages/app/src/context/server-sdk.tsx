import type { Darkie CoderEvent } from "@opencode-ai/client/promise"
...
export type ServerEvent = Event & { current?: Darkie CoderEvent }
...
export function adaptServerEvent(event: Darkie CoderEvent): ServerEvent {
...
function currentDelta(event: Darkie CoderEvent | undefined): CurrentDelta | undefined {
  if (

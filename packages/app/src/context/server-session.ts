...
import type { Darkie CoderEvent, SessionApi, SessionMessageInfo } from "@opencode-ai/client/promise"
import type {
  Message,
  Darkie CoderClient,
  Part,
...
export function createServerSession(
  ...
  const applyV2 = (event: Darkie CoderEvent) => {

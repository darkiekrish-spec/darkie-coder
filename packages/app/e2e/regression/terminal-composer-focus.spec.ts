...
const directory = "C:/Darkie Coder/TerminalComposerFocus"
...
function seedCachedTerminal(page: Page) {
  return page.addInitScript(
    ({ terminalKey, ptyID }) => {
      localStorage.setItem("darkie-coder.global.dat:layout", JSON.stringify({ terminal: { height: 320, opened: true } }))

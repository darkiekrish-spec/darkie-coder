...
class Database extends Context.Service<Database, DatabaseShape>()("@darkie-coder/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@darkie-coder/example/UserStore") {

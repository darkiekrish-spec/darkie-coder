import darkie-coderWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  href: "https://github.com/anomalyco/darkie-coder",
  apiHref: "https://api.github.com/repos/anomalyco/darkie-coder",
  fallbackStars: "195K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "darkie-coder:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://darkie-coder.ai/">
            <strong>{i18n.t("header.tryDarkie Coder")}</strong>
          </a>
          <button
...
function Darkie CoderMark() {
  return (
    <svg data-slot="darkie-coder-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://darkie-coder.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://darkie-coder.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@darkie-coder.ai", label: i18n.t("footer.contact") },
    { href: "https://darkie-coder.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/darkie-coder", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://darkie-coder.ai" aria-label={i18n.t("footer.homeAria")}>
          <Darkie CoderMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={darkie-coderWordmarkDark} alt="Darkie Coder" />
          <button

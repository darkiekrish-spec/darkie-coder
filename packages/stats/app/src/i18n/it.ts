export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Darkie Coder Data",
  "app.description":
    "Esplora l'utilizzo di Darkie Coder nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Darkie Coder Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Darkie Coder su GitHub",
  "header.github": "GitHub",
  "header.tryDarkie Coder": "Prova Darkie Coder",
  ...
  "footer.homeAria": "Home Darkie Coder",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Darkie Coder.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Darkie Coder per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Darkie Coder Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Darkie Coder, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Darkie Coder.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Darkie Coder",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Darkie Coder",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Darkie Coder negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Darkie Coder Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Darkie Coder, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Darkie Coder appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Darkie Coder della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Darkie Coder della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Darkie Coder nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Darkie Coder, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Darkie Coder.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Darkie Coder nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Darkie Coder nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Darkie Coder.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica Darkie Coder corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token Darkie Coder.",

export const dict = {
  "app.title": "Rankingi użycia modeli AI | Darkie Coder Data",
  "app.description":
    "Przeglądaj użycie Darkie Coder w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Darkie Coder Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Darkie Coder na GitHub",
  "header.github": "GitHub",
  "header.tryDarkie Coder": "Wypróbuj Darkie Coder",
  ...
  "footer.homeAria": "Strona główna Darkie Coder",
  ...
  "home.topModelsDescription": "Użycie modeli w Darkie Coder.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Darkie Coder według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Darkie Coder Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Darkie Coder, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Darkie Coder.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Darkie Coder",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Darkie Coder",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Darkie Coder z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Darkie Coder Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Darkie Coder, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Darkie Coder pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Darkie Coder z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Darkie Coder z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Darkie Coder w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Darkie Coder, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Darkie Coder.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Darkie Coder w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Darkie Coder w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Darkie Coder.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne Darkie Coder nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Darkie Coder.",

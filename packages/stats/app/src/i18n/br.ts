export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Darkie Coder Data",
  "app.description":
    "Explore o uso do Darkie Coder em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Darkie Coder Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Darkie Coder no GitHub",
  "header.github": "GitHub",
  "header.tryDarkie Coder": "Experimente o Darkie Coder",
  ...
  "footer.homeAria": "Início do Darkie Coder",
  ...
  "modal.title": "Newsletter do Darkie Coder",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Darkie Coder.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Darkie Coder por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Darkie Coder Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Darkie Coder, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Darkie Coder.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Darkie Coder",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Darkie Coder",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Darkie Coder nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Darkie Coder Data",
  "model.description":
    "Veja dados de uso de {{model}} no Darkie Coder, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Darkie Coder aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Darkie Coder da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Darkie Coder da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Darkie Coder na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Darkie Coder, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Darkie Coder.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Darkie Coder na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Darkie Coder na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Darkie Coder.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do Darkie Coder correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Darkie Coder.",

export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | Darkie Coder Data",
  "app.description":
    "Explora el uso de Darkie Coder en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de Darkie Coder Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a Darkie Coder en GitHub",
  "header.github": "GitHub",
  "header.tryDarkie Coder": "Probar Darkie Coder",
  ...
  "footer.homeAria": "Inicio de Darkie Coder",
  ...
  "modal.title": "Boletín de Darkie Coder",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en Darkie Coder.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de Darkie Coder por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | Darkie Coder Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en Darkie Coder, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de Darkie Coder.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en Darkie Coder",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de Darkie Coder",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de Darkie Coder durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | Darkie Coder Data",
  "model.description":
    "Consulta datos de uso de {{model}} en Darkie Coder, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de Darkie Coder aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de Darkie Coder de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de Darkie Coder de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de Darkie Coder en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de Darkie Coder, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de Darkie Coder.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de Darkie Coder durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de Darkie Coder durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de Darkie Coder.",
  ...
  "model.noGeoDescription": "Ninguna fila geográfica de Darkie Coder coincidió con este modelo.",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de Darkie Coder.",

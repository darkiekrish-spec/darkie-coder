...
const en = {
  "app.title": "AI Model Usage Rankings | Darkie Coder Data",
  "app.description":
    "Explore Darkie Coder usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Darkie Coder Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Darkie Coder on GitHub",
  "header.github": "GitHub",
  "header.tryDarkie Coder": "Try Darkie Coder",
  ...
  "footer.homeAria": "Darkie Coder home",
  ...
  "home.topModelsDescription": "Usage of models across Darkie Coder.",
  ...
  "home.uniqueUsersDescription": "Daily unique Darkie Coder users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Darkie Coder Data",
  "lab.description":
    "Compare {{lab}} models used in Darkie Coder, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Darkie Coder usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Darkie Coder",
  ...
  "lab.shareOfUsage": "{{share}} of recent Darkie Coder usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Darkie Coder Data",
  "model.description":
    "View {{model}} Darkie Coder usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Darkie Coder usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Darkie Coder usage",
  "model.ranked": "Ranked #{{rank}} across last week's Darkie Coder usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Darkie Coder usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Darkie Coder usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No Darkie Coder geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent Darkie Coder token volume.",

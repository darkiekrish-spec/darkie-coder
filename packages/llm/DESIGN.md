...
- Secondary audience: Darkie Coder and other durable agent runtimes
...
Darkie Coder and other durable runtimes need to own persistence, tool settlement,
...
Darkie Coder should migrate to `generateTurn` / `streamTurn`, preserving its durable

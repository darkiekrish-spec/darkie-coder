...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new Darkie CoderClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Darkie Coder system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Darkie Coder system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the Darkie Coder server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Darkie Coder state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Darkie Coder configuration settings and preferences.
   */
   ...
   *
   * Update global Darkie Coder configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Darkie Coder server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Darkie Coder system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Darkie Coder instances, releasing all resources.
   */
  ...
  /**
   * Upgrade darkie-coder
   *
   * Upgrade darkie-coder to the specified version.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Darkie Coder configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Darkie Coder configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Darkie Coder instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Darkie Coder system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Darkie Coder.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Darkie Coder is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Darkie Coder.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Darkie Coder sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Darkie Coder session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Darkie Coder session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this Darkie Coder process. Idle interruption is a no-op.
   */
...
export class Darkie CoderClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<Darkie CoderClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    Darkie CoderClient.__registry.set(this, args?.key)
  }

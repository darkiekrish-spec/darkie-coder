...
const releaseId = process.env.DARKIE_CODER_RELEASE
if (!releaseId) throw new Error("DARKIE_CODER_RELEASE is required")

const version = process.env.DARKIE_CODER_VERSION
if (!version) throw new Error("DARKIE_CODER_VERSION is required")
...
const macxTarGz = "darkie-coder-desktop-mac-x64.app.tar.gz"
const macaTarGz = "darkie-coder-desktop-mac-arm64.app.tar.gz"

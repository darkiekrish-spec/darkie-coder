export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon Darkie Coder ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "Darkie Coderning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'darkie-coder' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",

export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የDarkie Coder ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከDarkie Coder ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
  ...
  "desktop.cli.installed.message": "CLI ወደ {{path}} ተጭኗል\n\nየ'darkie-coder' ትዕዛዝን ለመጠቀም ተርሚናልዎን እንደገና ያስጀምሩት።",

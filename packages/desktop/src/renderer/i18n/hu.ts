export const dict = {
  ...
  "desktop.updater.none.message": "Már az Darkie Coder legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Darkie Coder {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
  ...
  "desktop.cli.installed.message":
    "A CLI telepítési helye: {{path}}\n\nIndítsa újra a terminált az 'darkie-coder' parancs használatához.",

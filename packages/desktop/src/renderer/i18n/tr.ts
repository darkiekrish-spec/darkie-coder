export const dict = {
  ...
  "desktop.updater.none.message": "Darkie Coder'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Darkie Coder'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'darkie-coder' komutunu kullanmak için terminalinizi yeniden başlatın.",

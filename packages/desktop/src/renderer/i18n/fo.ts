export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av Darkie Coder.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av Darkie Coder er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
  ...
  "desktop.cli.installed.message":
    "CLI sett upp í {{path}}\n\nEndurbyrja terminalin fyri at brúka skipanina 'darkie-coder'.",

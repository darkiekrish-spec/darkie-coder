export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Darkie Codern uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Darkie Codern versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Darkie Codern uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'darkie-coder'-komentoa.",

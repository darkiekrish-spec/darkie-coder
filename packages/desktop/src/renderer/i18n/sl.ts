export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico Darkie Coder",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} Darkie Coder je bila prenesena, jo želite namestiti in znova zagnati?",
  ...
  "desktop.cli.installed.message":
    "CLI je nameščen v {{path}}\n\nZnova zaženite terminal, da lahko uporabite ukaz 'darkie-coder'.",

export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Darkie Coder",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Darkie Coder er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert i {{path}}\n\nStart terminalen på nytt for å bruke 'darkie-coder'-kommandoen.",

export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Darkie Coder",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Darkie Coder er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'darkie-coder'-kommandoen.",

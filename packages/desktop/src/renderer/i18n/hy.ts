export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Darkie Coder-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Darkie Coder-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
  ...
  "desktop.cli.installed.message":
    "CLI-ն տեղադրված է {{path}}-ում\n\nՎերագործարկեք ձեր տերմինալը՝ «darkie-coder» հրամանն օգտագործելու համար:",

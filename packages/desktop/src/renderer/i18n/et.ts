export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Darkie Coder uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Darkie Coder'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „darkie-coder” kasutamiseks taaskäivitage terminal.",

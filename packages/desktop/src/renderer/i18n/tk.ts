export const dict = {
  ...
  "desktop.updater.none.message": "Darkie Coder-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "Darkie Coder-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'darkie-coder' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",

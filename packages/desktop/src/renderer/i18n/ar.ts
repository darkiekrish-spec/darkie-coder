export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Darkie Coder",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من Darkie Coder. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",

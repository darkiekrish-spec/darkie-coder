export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Darkie Coder",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Darkie Coder è stata scaricata. Vuoi installarla e riavviare l'app?",
  ...
  "desktop.cli.installed.message":
    "CLI installata in {{path}}\n\nRiavvia il terminale per utilizzare il comando 'darkie-coder'.",

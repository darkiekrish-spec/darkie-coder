export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Darkie Coder を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Darkie Coder のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'darkie-coder' コマンドを使用してください。",

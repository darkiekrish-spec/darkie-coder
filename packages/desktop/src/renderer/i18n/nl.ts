export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Darkie Coder",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Darkie Coder is gedownload. Wil je deze installeren en Darkie Coder opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'darkie-coder' te gebruiken.",

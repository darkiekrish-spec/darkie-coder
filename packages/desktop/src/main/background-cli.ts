...
const desktopStateNames = ["ai.darkie-coder.desktop.dev", "ai.darkie-coder.desktop.beta", "ai.darkie-coder.desktop"]
...
function executableName() {
  return process.platform === "win32" ? "darkie-coder-cli.exe" : "darkie-coder-cli"
}

---
title: LSP serveri
description: Darkie Coder se integriše sa vašim LSP serverima.
---

Darkie Coder se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Darkie Coder dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `DARKIE_CODER_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i darkie-coder otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj darkie-coder konfiguraciji.

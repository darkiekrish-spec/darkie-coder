---
title: SDK
description: Type-safe JS klijent za darkie-coder server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

darkie-coder JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
Koristite ga za izradu integracija i programsko upravljanje darkie-coder-om.
...
Kreirajte instancu darkie-coder:
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `darkie-coder.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu darkie-coder instancu, mozete napraviti klijentsku instancu i povezati se na nju:

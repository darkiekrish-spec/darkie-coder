...
Kreiraj `.darkie-coder/commands/test.md`:
...
Možete dodati prilagođene komande kroz Darkie Coder konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Darkie Coder [config](/docs/config):
...
- Globalno: `~/.config/darkie-coder/commands/`
- Po projektu: `.darkie-coder/commands/`
...
Darkie Coder uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note

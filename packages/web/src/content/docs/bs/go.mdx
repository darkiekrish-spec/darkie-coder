...
Darkie Coder Go je povoljna pretplata od **$10/mjesečno** koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.

Go radi kao bilo koji drugi provajder u Darkie Coder-u. Pretplatite se na Darkie Coder Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili Darkie Coder.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa Darkie Coder-om.
:::
...
Darkie Coder Go vam daje pristup ovim modelima za **$10/mjesečno**.

---

## Kako funkcioniše

Darkie Coder Go radi kao bilo koji drugi provajder u Darkie Coder-u.

1. Prijavite se na **<a href={console}>Darkie Coder Zen</a>**, pretplatite se na Go i
   kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI-ju, odaberite `Darkie Coder Go` i zalijepite
   svoj API ključ.
3. Pokrenite `/models` u TUI-ju da vidite listu modela dostupnih kroz Go.

:::note
Samo jedan član po radnom prostoru (workspace) može se pretplatiti na Darkie Coder Go.
:::
...
Darkie Coder Go je osmišljen za [Darkie Coder](https://darkie-coder.ai) i druge agente za programiranje
...
3. Slati stabilan ID sesije u zaglavlju `x-darkie-coder-session` za svaki razgovor kako bismo mogli optimizovati usmjeravanje i
   keširanje promptova.

### Provjereni klijenti

Pored Darkie Coder-a, potvrđeno je da sljedeći klijenti ispravno rade
s Darkie Coder Go. Ipak, ne garantiramo da će nastaviti raditi i u budućnosti.

| Klijent           | Podrška za sesije                                                                                                                                                                                                                                          |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Buildovi koji sadrže [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) šalju zaglavlje u glavnim i pomoćnim Darkie Coder zahtjevima. Ispravka je spojena nakon verzije v0.21.0; samo to izdanje je ne sadrži.                             |
...
| **ZCode**         | Go prepoznaje njegovo izvorno zaglavlje sesije. Naš [zahtjev za `x-darkie-coder-session`](https://github.com/zai-org/feedback/issues/492) i dalje je otvoren, ali slanje tog konkretnog zaglavlja više nije potrebno.                                          |
| **Pi**            | Trenutni buildovi šalju informacije o sesiji za Darkie Coder. Ažurirajte starije instalacije.                                                                                                                                                                  |
...
| **Kilo Code CLI** | Buildovi koji sadrže [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) vraćaju Darkie Coder zaglavlja sesije. Ova ispravka obuhvata CLI, ali ne i VS Code ekstenziju. Pogledajte [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
[Model id](/docs/config/#models) u vašoj Darkie Coder konfiguraciji
koristi format `darkie-coder-go/<model-id>`. Na primjer, za Kimi K3, koristili biste
`darkie-coder-go/kimi-k3` u svojoj konfiguraciji.
...
Napravili smo Darkie Coder Go da bismo:
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz Darkie Coder koristite i bilo kojeg drugog provajdera.

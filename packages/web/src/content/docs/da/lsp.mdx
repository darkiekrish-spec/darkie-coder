---
title: LSP-servere
description: Darkie Coder integreres med dine LSP-servere.
---

Darkie Coder kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Darkie Coder leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `DARKIE_CODER_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og darkie-coder åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din darkie-coder-konfiguration.

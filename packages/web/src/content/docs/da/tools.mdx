...
Her er alle de innebygde verktøyene som er tilgængelige i Darkie Coder.
...
:::note
Dette verktøyet er bare tilgængelig når `DARKIE_CODER_EXPERIMENTAL_LSP_TOOL=true` (eller `DARKIE_CODER_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Darkie Coder-leverandøren eller når miljøvariabelen `DARKIE_CODER_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).

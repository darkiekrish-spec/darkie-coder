...
Opret `.darkie-coder/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Darkie Coder-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Darkie Coder [config](/docs/config):
...
- Globalt: `~/.config/darkie-coder/commands/`
- Pr. projekt: `.darkie-coder/commands/`
...
darkie-coder indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).

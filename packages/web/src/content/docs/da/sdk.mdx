...
Brug den til at bygge integrasjoner og kontrollere darkie-coder programmatisk.
...
Opret en forekomst av darkie-coder:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `darkie-coder.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av darkie-coder, kan du oprete en klientforekomst for at koble til den:

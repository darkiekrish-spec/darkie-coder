...
description: Opret værktøjer, som LLM kan kalde darkie-coder ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med darkie-coders [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.darkie-coder/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/darkie-coder/tools/`.

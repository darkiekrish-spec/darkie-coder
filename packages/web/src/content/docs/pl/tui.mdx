---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala darkie-coder.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

darkie-coder zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie darkie-coder uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI darkie-coder, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do darkie-coder. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij darkie-coder. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `darkie-coder.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Darkie Coder czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `darkie-coder.default`.

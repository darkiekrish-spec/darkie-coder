---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące darkie-coder.
---

Funkcja udostępniania darkie-coder umożliwia tworzenie publicznych linków do konwersacji darkie-coder, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, darkie-coder:
...
darkie-coder obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie darkie-coder korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `darkie-coder.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu darkie-coder w Twojej organizacji.

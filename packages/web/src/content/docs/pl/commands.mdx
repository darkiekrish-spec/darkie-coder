...
Utwórz `.darkie-coder/commands/test.md`:
...
Możesz zdefiniować polecenia w `darkie-coder.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji darkie-coder:
...
- Globalnie: `~/.config/darkie-coder/commands/`
- Na projekt: `.darkie-coder/commands/`
...
darkie-coder zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).

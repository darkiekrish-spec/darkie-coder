---
title: Teilen
description: Teile Darkie Coder-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Darkie Coder-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Darkie Coder Folgendes:
...
Darkie Coder hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Darkie Coder den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`darkie-coder.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du darkie-coder in deiner Organisation einsetzt.

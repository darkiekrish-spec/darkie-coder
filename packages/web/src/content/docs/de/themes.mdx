...
Mit Darkie Coder kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Darkie Coder das `darkie-coder`-Theme.
...
Darkie Coder liefert mehrere eingebaute Themes mit.
...
- Darkie Coder optisch ans Terminal anpassen wollen
...
Darkie Coder unterstuetzt ein flexibles JSON-basiertes Theme-System.
...
2. **Benutzer-Config-Verzeichnis** - Definiert in `~/.config/darkie-coder/themes/*.json` oder `$XDG_CONFIG_HOME/darkie-coder/themes/*.json`
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.darkie-coder/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.darkie-coder/themes/*.json`

...
Erstellen Sie `.darkie-coder/commands/test.md`:

```md title=".darkie-coder/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Darkie Coder-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Darkie Coder [config](/docs/config):

```json title="darkie-coder.jsonc" {4-12}
{
...
- Global: `~/.config/darkie-coder/commands/`
- Pro Projekt: `.darkie-coder/commands/`

```markdown title="~/.config/darkie-coder/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".darkie-coder/commands/component.md"
---
...
```md title=".darkie-coder/commands/create-file.md"
---
...
```md title=".darkie-coder/commands/analyze-coverage.md"
---
...
```md title=".darkie-coder/commands/review-changes.md"
---
...
```md title=".darkie-coder/commands/review-component.md"
---
...
Darkie Coder enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).

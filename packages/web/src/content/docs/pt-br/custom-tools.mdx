...
description: Crie ferramentas que o LLM pode chamar no darkie-coder.
---

Ferramentas personalizadas são funções que você cria e que o LLM pode chamar durante as conversas. Elas funcionam junto com as [ferramentas integradas](/docs/tools) do darkie-coder, como `read`, `write` e `bash`.
...
- Localmente, colocando-as no diretório `.darkie-coder/tools/` do seu projeto.
- Ou globalmente, colocando-as em `~/.config/darkie-coder/tools/`.

---
title: SDK
description: Cliente JS seguro em tipos para o servidor darkie-coder.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

O SDK JS/TS do darkie-coder fornece um cliente seguro em tipos para interagir com o servidor.
Use-o para construir integrações e controlar o darkie-coder programaticamente.
...
Crie uma instância do darkie-coder:
...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `darkie-coder.json`, mas você pode substituir ou adicionar configuração inline:
...
Se você já tem uma instância do darkie-coder em execução, pode criar uma instância de cliente para se conectar a ela:

---
title: Paylasim
description: darkie-coder konusmalarini genel baglantilarla paylasin.
---

darkie-coder'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda darkie-coder:
...
darkie-coder, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak darkie-coder manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `darkie-coder.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda darkie-coder kullanimi icin [daha fazla bilgi alin](/docs/enterprise).

---
title: Özel Araçlar
description: LLM'un darkie-coder'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. darkie-coder'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.darkie-coder/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/darkie-coder/tools/` içine yerleştirerek.

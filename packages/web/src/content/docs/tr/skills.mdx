...
Ajan becerileri, darkie-coder'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
darkie-coder su konumlari tarar:

- Proje konfigurasyonu: `.darkie-coder/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/darkie-coder/skills/<name>/SKILL.md`
...
Proje yerel yollarinda darkie-coder, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.darkie-coder/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/darkie-coder/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.darkie-coder/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
darkie-coder, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`darkie-coder.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`darkie-coder.json` icinde):

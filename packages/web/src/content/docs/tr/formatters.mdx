...
description: darkie-coder dile özgü biçimlendiriciler kullanır.
---

darkie-coder, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

darkie-coder, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, darkie-coder bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

darkie-coder bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri darkie-coder yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.

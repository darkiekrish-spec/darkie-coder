...
`.darkie-coder/commands/test.md` oluştur:
...
darkie-coder işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

darkie-coder [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/darkie-coder/commands/`
- Proje başına: `.darkie-coder/commands/`
...
darkie-coder, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).

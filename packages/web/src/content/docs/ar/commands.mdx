...
أنشئ الملف `.darkie-coder/commands/test.md`:
...
يمكنك إضافة أوامر مخصصة عبر إعدادات Darkie Coder أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ Darkie Coder:
...
- على مستوى النظام: `~/.config/darkie-coder/commands/`
- لكل مشروع: `.darkie-coder/commands/`
...
يتضمن darkie-coder عدة أوامر مضمنة مثل `/init` و`/undo` و`/redo` و`/share` و`/help`؛ [اعرف المزيد](/docs/tui#commands).

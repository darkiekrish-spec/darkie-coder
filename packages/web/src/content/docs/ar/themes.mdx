...
مع Darkie Coder يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم Darkie Coder سمتنا `darkie-coder`.
...
يأتي Darkie Coder مع عدة سمات مدمجة.
...
- يريدون أن يطابق Darkie Coder مظهر terminal لديهم
...
يدعم Darkie Coder نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
2. **مجلد ضبط المستخدم** - معرّف في `~/.config/darkie-coder/themes/*.json` أو `$XDG_CONFIG_HOME/darkie-coder/themes/*.json`
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.darkie-coder/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.darkie-coder/themes/*.json`

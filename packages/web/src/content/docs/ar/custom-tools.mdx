...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في darkie-coder.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في darkie-coder مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.darkie-coder/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/darkie-coder/tools/`.

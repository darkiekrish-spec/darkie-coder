---
title: Share
description: Share your Darkie Coder conversations.
---

Darkie Coder's share feature allows you to create public links to your Darkie Coder conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Darkie Coder:
...
Darkie Coder supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Darkie Coder uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `darkie-coder.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using darkie-coder in your organization.

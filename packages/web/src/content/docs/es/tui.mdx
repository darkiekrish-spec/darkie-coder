---
title: TUI
description: Usando la interfaz de usuario del terminal Darkie Coder.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Darkie Coder proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Darkie Coder se inicia TUI para el directorio actual.
...
Cuando utilice Darkie Coder TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Darkie Coder. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Darkie Coder. _Alias_: `/quit`, `/q`
...
Esto es independiente de `darkie-coder.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera Darkie Coder después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `darkie-coder.default`.

...
Con Darkie Coder puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Darkie Coder usa nuestro propio tema `darkie-coder`.
...
Darkie Coder viene con varios temas integrados.
...
- Quiere que Darkie Coder coincida con la apariencia de su terminal
...
Darkie Coder admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/darkie-coder/themes/*.json` o `$XDG_CONFIG_HOME/darkie-coder/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.darkie-coder/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.darkie-coder/themes/*.json`

...
Crear `.darkie-coder/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Darkie Coder o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Darkie Coder [config](/docs/config):
...
- Por proyecto: `.darkie-coder/commands/`
...
darkie-coder incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).

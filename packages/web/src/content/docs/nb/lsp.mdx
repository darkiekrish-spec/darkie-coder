---
title: LSP-servere
description: darkie-coder integreres med LSP-serverne dine.
---

Darkie Coder kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Darkie Coder kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `DARKIE_CODER_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og darkie-coder åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Darkie Coder-konfigurasjonen.

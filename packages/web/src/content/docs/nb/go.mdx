...
Darkie Coder Go er et lavkostnadsabonnement til **$10/måned** som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i Darkie Coder. Du abonnerer på Darkie Coder Go og
...
Darkie Coder Go gir deg tilgang til disse modellene for **$10/måned**.

---

## Hvordan det fungerer

Darkie Coder Go fungerer som enhver annen leverandør i Darkie Coder.

1. Du logger inn på **<a href={console}>Darkie Coder Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `Darkie Coder Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på Darkie Coder Go.
:::
...
Darkie Coder Go er utviklet for [Darkie Coder](https://darkie-coder.ai) og andre kodeagenter
...
3. Sende en stabil sesjons-ID i `x-darkie-coder-session` for hver samtale, slik at vi kan optimalisere ruting og
   promptbufring.

### Validerte klienter

I tillegg til Darkie Coder er følgende klienter validert for å fungere riktig
med Darkie Coder Go. Vi garanterer imidlertid ikke at de vil fortsette å fungere i fremtiden.

| Klient            | Sesjonsstøtte                                                                                                                                                                                                                                          |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Hermes**        | Bygg som inneholder [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864), sender headeren i primære og sekundære Darkie Coder-forespørsler. Rettelsen ble slått sammen etter v0.21.0; den versjonen inneholder den ikke alene.           |
...
| **ZCode**         | Go gjenkjenner den innebygde sesjonsheaderen. Vår [forespørsel om `x-darkie-coder-session`](https://github.com/zai-org/feedback/issues/492) er fortsatt åpen, men det er ikke lenger nødvendig å sende akkurat denne headeren.                             |
| **Pi**            | Gjeldende bygg sender sesjonsinformasjon for Darkie Coder. Oppdater eldre installasjoner.                                                                                                                                                                  |
...
| **Kilo Code CLI** | Bygg som inneholder [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752), gjenoppretter Darkie Coder-sesjonsheadere. Denne rettelsen dekker CLI-en, ikke VS Code-utvidelsen. Se [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
[Modell-ID-en](/docs/config/#models) i din Darkie Coder-konfigurasjon
bruker formatet `darkie-coder-go/<model-id>`. For eksempel, for Kimi K3, vil du
bruke `darkie-coder-go/kimi-k3` i konfigurasjonen din.
...
Vi opprettet Darkie Coder Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Darkie Coder også.

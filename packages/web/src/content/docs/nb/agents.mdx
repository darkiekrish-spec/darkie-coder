...
Det er to typer agenter i Darkie Coder; primære agenter og underagenter.
...
Darkie Coder kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
Darkie Coder kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

Darkie Coder kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Konfigurer agenter i konfigurasjonsfilen `darkie-coder.json`:
...
- Per prosjekt: `.darkie-coder/agents/`
...
Hvis ingen temperatur er spesifisert, bruker Darkie Coder modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale Darkie Coder-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i Darkie Coder-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [Darkie Coder Zen](/docs/zen), vil du bruke `darkie-coder/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `darkie-coder models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/anomalyco/darkie-coder).
:::

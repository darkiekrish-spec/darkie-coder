...
Opprett `.darkie-coder/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Darkie Coder-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Darkie Coder [config](/docs/config):
...
- Per prosjekt: `.darkie-coder/commands/`
...
Darkie Coder inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).

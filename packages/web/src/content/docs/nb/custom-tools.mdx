...
description: Lag verktøy som LLM kan kalle inn Darkie Coder.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Darkie Coder sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.darkie-coder/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/darkie-coder/tools/`.

---
title: TUI
description: Bruke darkie-coder-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Darkie Coder gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Darkie Coder starter TUI for gjeldende katalog.
...
Når du bruker Darkie Coder TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Darkie Coder. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Darkie Coder. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `darkie-coder.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Darkie Coder venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `darkie-coder.default`.

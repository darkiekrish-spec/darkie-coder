---
title: Deling
description: Del dine Darkie Coder-samtaler.
---

Delingsfunksjonen i Darkie Coder lar deg lage offentlige lenker til dine Darkie Coder-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, Darkie Coder:
...
Darkie Coder støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker Darkie Coder manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `darkie-coder.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av darkie-coder i organisasjonen din.

---
title: SDK
description: Typesikker JS-klient for Darkie Coder-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Darkie Coder JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere Darkie Coder programmatisk.
...
Opprett en forekomst av Darkie Coder:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `darkie-coder.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av Darkie Coder, kan du opprette en klientforekomst for å koble til den:

...
Agentferdigheter lar Darkie Coder oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går darkie-coder opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
darkie-coder viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `darkie-coder.json`:

...
Create `.darkie-coder/commands/test.md`:
...
You can add custom commands through the Darkie Coder config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Darkie Coder [config](/docs/config):
...
- Per-project: `.darkie-coder/commands/`
...
darkie-coder includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).

...
สร้าง `.darkie-coder/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Darkie Coder:
...
- ระดับผู้ใช้ (Global): `~/.config/darkie-coder/commands/`
- ระดับโปรเจ็กต์: `.darkie-coder/commands/`
...
Darkie Coder มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)

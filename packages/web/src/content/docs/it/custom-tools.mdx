...
description: Crea strumenti che l'LLM puo chiamare in darkie-coder.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di darkie-coder come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.darkie-coder/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/darkie-coder/tools/`.

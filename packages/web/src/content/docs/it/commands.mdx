...
Crea `.darkie-coder/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Darkie Coder o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Darkie Coder:
...
- Globale: `~/.config/darkie-coder/commands/`
- Per progetto: `.darkie-coder/commands/`
...
darkie-coder include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).

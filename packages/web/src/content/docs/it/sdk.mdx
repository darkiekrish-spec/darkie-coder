---
title: SDK
description: Client JS type-safe per il server darkie-coder.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

L'SDK JS/TS di darkie-coder fornisce un client type-safe per interagire con il server.
Usalo per creare integrazioni e controllare darkie-coder in modo programmatico.
...
Crea un'istanza di darkie-coder:
...
Puoi passare un oggetto di configurazione per personalizzare il comportamento. L'istanza legge comunque `darkie-coder.json`, ma puoi sovrascrivere o aggiungere configurazione inline:
...
Se hai gia un'istanza di darkie-coder in esecuzione, puoi creare un client per collegarti:

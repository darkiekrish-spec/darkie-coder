...
Créez `.darkie-coder/commands/test.md` :
...
Vous pouvez ajouter des commandes personnalisées via la configuration Darkie Coder ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre Darkie Coder [config](/docs/config) :
...
- Par projet : `.darkie-coder/commands/`
...
darkie-coder comprend plusieurs commandes intégrées comme `/init`, `/undo`, `/redo`, `/share`, `/help` ; [en savoir plus](/docs/tui#commands).

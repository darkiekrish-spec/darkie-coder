...
import { IconDarkie Coder } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "darkie-coder/session/message-v2"
import type { Message } from "darkie-coder/session/message"
import type { Session } from "darkie-coder/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.darkie-coder_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.darkie-coder_name}>
                    <IconDarkie Coder width={16} height={16} />
                  </div>

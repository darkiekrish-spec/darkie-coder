...
export class Service extends Context.Service<Service, Interface>()("@darkie-coder/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.DARKIE_CODER_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))

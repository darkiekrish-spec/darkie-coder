...
export class ConfigService extends Context.Service<ConfigService, Config>()("@darkie-coder/v2/WebSearchConfig") {}

/** Isolates the retained product environment contract from the generic tool implementation. */
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.DARKIE_CODER_WEBSEARCH_PROVIDER === "exa" || process.env.DARKIE_CODER_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.DARKIE_CODER_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("DARKIE_CODER_EXPERIMENTAL") || truthy("DARKIE_CODER_ENABLE_EXA") || truthy("DARKIE_CODER_EXPERIMENTAL_EXA"),
    enableParallel: truthy("DARKIE_CODER_ENABLE_PARALLEL") || truthy("DARKIE_CODER_EXPERIMENTAL_PARALLEL"),
              ...
              const text =
                provider === "exa"
                  ...
                  : yield* callMcp(
                      ...
                      {
                        "User-Agent": `darkie-coder/${InstallationVersion}`,

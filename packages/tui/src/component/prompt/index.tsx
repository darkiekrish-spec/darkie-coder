...
import { registerDarkie CoderSpinner } from "../register-spinner"
...
import { DARKIE_CODER_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useDarkie CoderKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.DARKIE_CODER_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },

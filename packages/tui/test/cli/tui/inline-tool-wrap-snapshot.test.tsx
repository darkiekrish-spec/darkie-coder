...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "DARKIE_CODER.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/darkie-coder/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/darkie-coder (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/darkie-coder/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/darkie-coder/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const DARKIE_CODER_DB|DARKIE_CODER_DB|DARKIE_CODER_DEV|Global\\.Path\\.data|data =" in packages/darkie-coder/src (115 matches)',
  },
] as const

...
declare const DARKIE_CODER_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof DARKIE_CODER_CLI_NAME === "string" ? DARKIE_CODER_CLI_NAME : "darkie-coder", {
  description: "Darkie Coder 2.0 preview command line interface",
  commands: [
    Spec.make("api", {

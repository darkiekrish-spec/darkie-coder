...
brew install anomalyco/tap/darkie-coder # macOS 和 Linux（推荐，始终保持最新）
brew install darkie-coder              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S darkie-coder            # Arch Linux (Stable)
paru -S darkie-coder-bin               # Arch Linux (Latest from AUR)
mise use -g darkie-coder               # 任意系统
nix run nixpkgs#darkie-coder           # 或用 github:anomalyco/darkie-coder 获取最新 dev 分支
```
...
Darkie Coder 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/anomalyco/darkie-coder/releases) 或 [darkie-coder.ai/download](https://darkie-coder.ai/download) 下载。
...
1. `$DARKIE_CODER_INSTALL_DIR` - 自定义安装目录
2. `$XDG_BIN_DIR` - 符合 XDG 基础目录规范的路径
3. `$HOME/bin` - 如果存在或可创建的用户二进制目录
4. `$HOME/.darkie-coder/bin` - 默认备用路径
...
Darkie Coder 内置两种 Agent，可用 `Tab` 键快速切换：
...
了解更多 [Agents](https://darkie-coder.ai/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://darkie-coder.ai/docs)。

### 参与贡献

如有兴趣贡献代码，请在提交 PR 前阅读 [贡献指南 (Contributing Docs)](./CONTRIBUTING.md)。

### 基于 Darkie Coder 进行开发

如果你在项目名中使用了 “darkie-coder”（如 “darkie-coder-dashboard” 或 “darkie-coder-mobile”），请在 README 里注明该项目不是 Darkie Coder 团队官方开发，且不存在隶属关系。

---

**加入我们的社区** [飞书](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=52ao9352-5623-4fa0-b7dd-3407c392c1af&qr_code=true) | [X.com](https://x.com/darkie-coder)

export const domain = (() => {
  if ($app.stage === "production") return "darkie-coder.ai"
  if ($app.stage === "dev") return "dev.darkie-coder.ai"
  return `${$app.stage}.dev.darkie-coder.ai`
})()

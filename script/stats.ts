...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/darkie-coder/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/darkie-coder...\n")
...
console.log("Fetching npm all-time downloads for darkie-coder-ai...\n")
const npmDownloads = await fetchNpmDownloads("darkie-coder-ai")

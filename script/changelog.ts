...
Generates UPCOMING_CHANGELOG.md by running the darkie-coder changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for darkie-coder run (default: low)
      --quiet            Suppress darkie-coder command output unless it fails

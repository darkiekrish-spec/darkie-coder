...
- PR #10018: https://github.com/anomalyco/darkie-coder/pull/10018
- PR #12935: https://github.com/anomalyco/darkie-coder/pull/12935

## Do Not Translate (Locale Additions)

- `Darkie Coder` (preserve casing in prose; keep `darkie-coder` only in commands, package names, paths, or code)
- `Darkie Coder CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`

...
- PR #15835: https://github.com/anomalyco/darkie-coder/pull/15835

## Do Not Translate (Locale Additions)

- `Darkie Coder` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `darkie-coder` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Darkie Coder` in prose, `darkie-coder` only for exact technical identifiers
...
- Avoid changing `darkie-coder` to `Darkie Coder` inside commands, URLs, package names, or code literals

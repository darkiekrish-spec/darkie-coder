...
Use this folder for locale-specific translation guidance that supplements `.darkie-coder/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/darkie-coder/pull/12345

## Do Not Translate (Locale Additions)

- `Darkie Coder` (preserve casing)

...
- PR #13942: https://github.com/anomalyco/darkie-coder/pull/13942

## Do Not Translate (Locale Additions)

- `Darkie Coder` (preserve casing in prose; keep `darkie-coder` only when it is part of commands, package names, paths, or code)
- `Darkie Coder Zen`
- `Darkie Coder CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `darkie-coder` in prose when referring to the product name; use `Darkie Coder`

...
// stats.darkie-coder.ai design tokens (light theme)
const c = {
  bg: "#ffffff",
  ink: "#161616",
  muted: "#5c5c5c",
...
// verified: Darkie Coder Go, week of Jun 22-28, 2026 (2026-W26). share = % of 19.64T total Go tokens.
const bars = [
      ...
      <div style={{ height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ marginTop: 50 }}>
          <div style={{ fontSize: 23, fontWeight: 600, color: c.muted, letterSpacing: 2 }}>
            DARKIE_CODER GO · SHARE OF TOKENS
          </div>
          <div
        ...
        >
          ...
          <div style={{ color: c.ink }}>darkie-coder.ai/data</div>
        </div>
      </div>
    </AbsoluteFill>
  )
